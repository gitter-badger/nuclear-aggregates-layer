...
{
    [ServiceContract(SessionMode = SessionMode.NotAllowed, Namespace = ServiceNamespaces.BasicOperations.Cancel201502)]
    public interface ICancelApplicationRestService
    {
        ...
        [FaultContract(typeof(CancelOperationErrorDescription))]
