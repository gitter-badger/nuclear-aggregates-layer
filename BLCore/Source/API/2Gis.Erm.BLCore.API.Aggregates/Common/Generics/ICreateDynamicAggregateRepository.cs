...
{
    public interface ICreateDynamicAggregateRepository<in TDynamicEntityInstance, in TDynamicEntityPropertyInstance> :
        IUnknownAggregateSpecificOperation<CreateIdentity>
