...
{
    public interface IDeleteDynamicAggregateRepository<in TDynamicEntityInstance, in TDynamicEntityPropertyInstance> :
        IUnknownAggregateSpecificOperation<DeleteIdentity>
