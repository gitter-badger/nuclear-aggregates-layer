...
namespace DoubleGis.Erm.BLCore.WCF.Operations
{
    ...
    public class CompleteApplicationService : ICompleteApplicationService, ICompleteApplicationRestService
    {
        ...
        public CompleteApplicationService(ICommonLog logger, IOperationServicesManager operationServicesManager, IUserContext userContext, IResourceGroupManager resourceGroupManager)
        {
            _logger = logger;
        ...
        {
            var CancelService = _operationServicesManager.GetCompleteService(entityName);
            CancelService.Complete(entityId);
        }
    }
}
