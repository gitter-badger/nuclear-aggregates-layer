...
namespace DoubleGis.Erm.BLCore.WCF.Operations
{
    ...
    public class DisqualifyApplicationService : IDisqualifyApplicationService, IDisqualifyApplicationRestService
    {
        ...
        public DisqualifyApplicationService(ITracer logger, IOperationServicesManager operationServicesManager, IUserContext userContext, IResourceGroupManager resourceGroupManager)
        {
            _logger = logger;
