...
{
    [Migration(3939, "Изменение хранимой процедуры ImportFirmFromXml")]
    public sealed class Migration3939 : TransactedMigration
    {
...
BEGIN TRY
	...
	WHERE NOT(XmlFirmDtos.IsHidden = 1 AND XmlFirmDtos.IsArchived = 1 AND NOT EXISTS(SELECT * FROM @Cards WHERE FirmCode = XmlFirmDtos.Code))
...
END CATCH";
            ...
            sp.TextBody = importFirmFromXmlText;
            sp.Alter();
        }
    }
}