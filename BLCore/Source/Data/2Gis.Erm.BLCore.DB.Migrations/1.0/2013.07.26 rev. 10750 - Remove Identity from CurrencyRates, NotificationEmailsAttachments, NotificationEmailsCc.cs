...
{
    [Migration(10750, "Отключаем автоинкремент в таблицах CurrencyRates, NotificationEmailsAttachments, NotificationEmailsCc")]
    public class Migration10750 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables =
        {
            ErmTableNames.CurrencyRates,
            ErmTableNames.NotificationEmailsAttachments,
            ErmTableNames.NotificationEmailsCc
        };
