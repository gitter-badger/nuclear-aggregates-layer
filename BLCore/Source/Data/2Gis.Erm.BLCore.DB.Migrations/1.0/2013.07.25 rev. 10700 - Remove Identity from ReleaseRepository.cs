...
{
    [Migration(10700, "Отключаем автоинкремент в таблицах ReleaseInfos, ReleaseValidationResults")]
    public class Migration10700 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
           ErmTableNames.ReleaseInfos,
           ErmTableNames.ReleaseValidationResults,
        };
