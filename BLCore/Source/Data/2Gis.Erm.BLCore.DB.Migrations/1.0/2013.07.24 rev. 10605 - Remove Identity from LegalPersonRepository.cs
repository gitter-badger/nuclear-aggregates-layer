...
{
    [Migration(10605, "Отключаем автоинкремент в таблицах LegalPersons, LegalPersonProfiles")]
    public sealed class Migration10605 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
            ErmTableNames.LegalPersons,
            ErmTableNames.LegalPersonProfiles
        };
