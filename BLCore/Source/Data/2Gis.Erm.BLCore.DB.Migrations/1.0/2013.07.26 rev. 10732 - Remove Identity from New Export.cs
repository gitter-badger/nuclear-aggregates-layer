...
{
    [Migration(10732, "Отключаем автоинкремент в таблицах ExportFailedEntities, PerformedBusinessOperations")]
    public class Migration10732 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
           ErmTableNames.ExportFailedEntities,
