...
{
    [Migration(10682, "Отключаем автоинкремент в таблицах Bargains, BargainFiles")]
    public sealed class Migration10682 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
           ErmTableNames.Bargains,
           ErmTableNames.BargainFiles
        };
