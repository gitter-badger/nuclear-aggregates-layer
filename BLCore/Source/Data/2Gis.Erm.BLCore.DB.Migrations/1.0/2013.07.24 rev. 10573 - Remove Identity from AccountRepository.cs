...
{
    [Migration(10573, "Отключаем автоинкремент в таблицах Accounts, AccountDetails, Limits, OperationTypes, Locks, LockDetails")]
    public sealed class Migration10573 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
            ErmTableNames.Accounts,
            ErmTableNames.AccountDetails,
            ErmTableNames.Limits,
            ErmTableNames.OperationTypes,
            ErmTableNames.Locks,
            ErmTableNames.LockDetails
        };
