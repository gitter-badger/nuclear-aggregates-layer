...
{
    [Migration(10728, "Отключаем автоинкремент в таблицах ActionsHistory, ActionsHistoryDetails")]
    public class Migration10728 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
           ErmTableNames.ActionsHistory,
           ErmTableNames.ActionsHistoryDetails
        };
