...
{
    [Migration(8931, "Alter на ReplicateLimit")]
    public sealed class Migration8931 : TransactedMigration
    {
        protected override void ApplyOverride(IMigrationContext context)
        {
            var sp = context.Database.StoredProcedures["ReplicateLimit", ErmSchemas.Billing];
