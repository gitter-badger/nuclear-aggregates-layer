...
{
    [Migration(9211, "Изменение хранимок ImportCardsFromXml")]
    public sealed class Migration9211 : TransactedMigration
    {
        #region ImportCardsFromXml
        private const string ImportCardsFromXml = @"
-- changes
...
";
        ...
        {
            context.Connection.ExecuteNonQuery(ImportCardsFromXml);
        }
    }
}
