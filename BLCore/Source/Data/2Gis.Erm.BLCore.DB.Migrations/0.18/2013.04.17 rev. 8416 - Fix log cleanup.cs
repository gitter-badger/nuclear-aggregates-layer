...
{
    [Migration(8416, "Исправляет процедуру чистки логов")]
    public sealed class Migration8416 : TransactedMigration
    {
        #region AlterCleanupERM
        private const string AlterCleanupERM = @"
SET ANSI_NULLS ON
GO
...
"; 
        ...
        #region CreateCleanupERMLogging
        private const string CreateCleanupERMLogging = @"
/****** Object:  StoredProcedure [Shared].[CleanupERM]    Script Date: 18.04.2013 16:44:56 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [Shared].[CleanupERMLogging]
	-- Add the parameters for the stored procedure here
	@logSizeInDays int
AS
BEGIN
...
"; 
        ...
        {
            context.Connection.ExecuteNonQuery(AlterCleanupERM);
            context.Connection.ExecuteNonQuery(CreateCleanupERMLogging);
        }
    }
}
