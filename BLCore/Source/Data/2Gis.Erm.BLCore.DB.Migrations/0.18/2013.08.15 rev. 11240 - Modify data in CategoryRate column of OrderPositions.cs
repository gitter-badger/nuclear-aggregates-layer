...
{
    [Migration(11240, "Импорт данных OrderPositions.CategoryRate из отчётов за август 2013")]
    public sealed class Migration11240 : TransactedMigration
    {
        private const int BatchSize = 1000; // Число строк, добавляемой в одном запросе InsertStatement. Взято с потолка.
        private const string DataForAugustResourceName = "DoubleGis.Erm.BLCore.DB.Migrations.Resources.2013.08.15 rev. 11240 - august 2013.xml";
