...
{
    [Migration(7523, "Третий alter хранимки AlterImportCards")]
    public sealed class Migration7523 : TransactedMigration
    {
...
BEGIN TRY
    ...
    BEGIN TRAN
       ...
       INSERT INTO @TerritoriesTbl EXEC Shared.GetTemporaryTerritories @OrganizationUnits = @BranchCodes, @ModifiedBy = @ModifiedBy, @EnableReplication = @EnableReplication
