...
{
    [Migration(6806, "Изменение логики загрузки карточек - получаем признак того, является ли рубрика основной")]
    public sealed class Migration6806 : TransactedMigration
    {
