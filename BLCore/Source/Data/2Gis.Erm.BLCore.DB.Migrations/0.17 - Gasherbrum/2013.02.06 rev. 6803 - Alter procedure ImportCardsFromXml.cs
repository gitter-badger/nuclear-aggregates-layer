...
{
    [Migration(6803, "Исправление хранимки ImportCardsFromXml. При загрузке DEP-карточек сохраняем Id фирмы для последующей обработки")]
    public sealed class Migration6803 : TransactedMigration
    {
