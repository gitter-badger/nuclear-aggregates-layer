...
{
    [Migration(6397, "Изменение логики загрузки карточек - теперь нам приходит информация, является ли карточка региональной")]
    public sealed class Migration6397 : TransactedMigration
    {
