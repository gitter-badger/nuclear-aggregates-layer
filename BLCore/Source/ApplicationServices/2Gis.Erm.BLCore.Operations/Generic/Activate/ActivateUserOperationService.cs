...
{
    public class ActivateUserOperationService : IActivateGenericEntityService<User>
    {
        private readonly IUserReadModel _readModel;
        private readonly IOperationScopeFactory _operationScopeFactory;
        private readonly IActivateUserAggregateService _aggregateService;

        public ActivateUserOperationService(IUserReadModel readModel, IActivateUserAggregateService aggregateService, IOperationScopeFactory operationScopeFactory)
        {
