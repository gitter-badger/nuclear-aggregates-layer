...
{
    public class DeleteOrganizationUnitService : IDeleteGenericEntityService<OrganizationUnit>
    {
        private readonly IUserRepository _userRepository;

        public DeleteOrganizationUnitService(IUserRepository userRepository)
        {
