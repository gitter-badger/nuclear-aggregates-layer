...
{
    public class DeleteCurrencyService : IDeleteGenericEntityService<DoubleGis.Erm.Platform.Model.Entities.Erm.Currency>
    {
        private readonly ICurrencyService _currencyService;

        public DeleteCurrencyService(ICurrencyService currencyService)
        {
