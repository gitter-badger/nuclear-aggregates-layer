...
{
    public class DeleteAdsTemplatesAdsElementTemplateOperationService : IDeleteGenericEntityService<AdsTemplatesAdsElementTemplate>
    {
        private readonly IAdvertisementRepository _advertisementRepository;
        private readonly IOperationScopeFactory _operationScopeFactory;

        public DeleteAdsTemplatesAdsElementTemplateOperationService(IAdvertisementRepository advertisementRepository, IOperationScopeFactory operationScopeFactory)
        {
