...
{
    public class DeleteAdvertisementService : IDeleteGenericEntityService<Advertisement>
    {
        private readonly IAdvertisementRepository _advertisementRepository;
        private readonly IOperationScopeFactory _scopeFactory;

        public DeleteAdvertisementService(IAdvertisementRepository advertisementRepository, IOperationScopeFactory scopeFactory)
        {
