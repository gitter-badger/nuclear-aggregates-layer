...
{
    public class DeletePlatformOperationService : IDeleteGenericEntityService<Platform.Model.Entities.Erm.Platform>
    {
        private readonly IPlatformService _platformService;
        private readonly IPositionRepository _positionRepository;
        private readonly IOperationScopeFactory _scopeFactory;

        public DeletePlatformOperationService(IPlatformService platformService, IPositionRepository positionRepository, IOperationScopeFactory scopeFactory)
        {
