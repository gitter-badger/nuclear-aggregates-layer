...
{
    public class DeleteOperationTypeService : IDeleteGenericEntityService<OperationType>
    {
        private readonly IAccountRepository _accountRepository;

        public DeleteOperationTypeService(IAccountRepository accountRepository)
        {
