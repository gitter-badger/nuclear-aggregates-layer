...
{
    public class DeletePositionCategoryOperationService : IDeleteGenericEntityService<PositionCategory>
    {
        private readonly IPositionRepository _positionRepository;
        private readonly IOperationScopeFactory _scopeFactory;

        public DeletePositionCategoryOperationService(IPositionRepository positionRepository, IOperationScopeFactory scopeFactory)
        {
