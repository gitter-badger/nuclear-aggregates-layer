...
{
    public class AppendThemeOrganizationUnitOperationService : IAppendGenericEntityService<OrganizationUnit, Theme>
    {
        private readonly IThemeRepository _themeRepository;
        private readonly IOperationScopeFactory _scopeFactory;

        public AppendThemeOrganizationUnitOperationService(IThemeRepository themeRepository, IOperationScopeFactory scopeFactory)
        {
