...
{
    public class AppendFirmDealOperationService : IAppendGenericEntityService<Firm, Deal>
    {
        private readonly IOperationScopeFactory _scopeFactory;
        private readonly ICreateFirmDealAggregateService _createAggregateService;
        private readonly IDealReadModel _dealReadModel;

        public AppendFirmDealOperationService(IOperationScopeFactory scopeFactory, ICreateFirmDealAggregateService createAggregateService, IDealReadModel dealReadModel)
        {
