...
{
    public class AppendThemeCategoryOperationService : IAppendGenericEntityService<Category, Theme>
    {
        private const int MaxCategoriesPerTheme = 5;
        private readonly IThemeRepository _themeRepository;
        private readonly IOperationScopeFactory _scopeFactory;

        public AppendThemeCategoryOperationService(IThemeRepository themeRepository, IOperationScopeFactory scopeFactory)
        {
        ...
        public void Append(AppendParams appendParams)
        {
            ...
            if (!appendParams.ParentType.Equals(EntityType.Instance.Theme()) || appendParams.AppendedType.Equals(EntityType.Instance.Category()))
            {
