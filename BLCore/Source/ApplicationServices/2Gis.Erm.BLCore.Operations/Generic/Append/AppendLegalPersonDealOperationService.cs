...
{
    public class AppendLegalPersonDealOperationService : IAppendGenericEntityService<LegalPerson, Deal>
    {
        private readonly IOperationScopeFactory _scopeFactory;
        private readonly ICreateLegalPersonDealAggregateService _createAggregateService;
        private readonly IDealReadModel _dealReadModel;

        public AppendLegalPersonDealOperationService(IOperationScopeFactory scopeFactory,
                                                     ICreateLegalPersonDealAggregateService createAggregateService,
