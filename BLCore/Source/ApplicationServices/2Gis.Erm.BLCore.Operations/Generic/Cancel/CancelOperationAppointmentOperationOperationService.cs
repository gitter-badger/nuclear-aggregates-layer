...
{
    public class CancelOperationAppointmentOperationOperationService : ICancelOperationGenericOperationService<Appointment>
    {
        ...
        public CancelOperationAppointmentOperationOperationService(
