...
{
    public class CancelOperationPhonecallOperationService : ICancelOperationGenericOperationService<Phonecall>
    {
        ...
        public CancelOperationPhonecallOperationService(
