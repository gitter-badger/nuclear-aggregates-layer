...
namespace DoubleGis.Erm.BLCore.Operations.Generic.Get
{
    public class GetReleaseInfoDtoService : GetDomainEntityDtoServiceBase<ReleaseInfo>
    {
        ...
        {
            return _finder.Find<ReleaseInfo>(x => x.Id == entityId)
                          .Select(entity => new ReleaseInfoDomainEntityDto
                              {
                                  ...
                                  Status = (ReleaseStatus)entity.Status,
        ...
        protected override IDomainEntityDto<ReleaseInfo> CreateDto(long? parentEntityId, EntityName parentEntityName, string extendedInfo)
        {
