...
namespace DoubleGis.Erm.BLCore.Operations.Generic.Get
{
    public class GetOperationDtoService : GetDomainEntityDtoServiceBase<Operation>
    {
                          ...
                          .Select(x => new OperationDomainEntityDto()
                              {
                                  ...
                                  Status = (OperationStatus)x.Status,
                                  Type = (BusinessOperation)x.Type,
        ...
        protected override IDomainEntityDto<Operation> CreateDto(long? parentEntityId, EntityName parentEntityName, string extendedInfo)
        {
