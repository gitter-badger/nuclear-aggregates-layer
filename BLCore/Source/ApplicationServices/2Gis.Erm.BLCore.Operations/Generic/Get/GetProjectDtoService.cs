...
namespace DoubleGis.Erm.BLCore.Operations.Generic.Get
{
    public class GetProjectDtoService : GetDomainEntityDtoServiceBase<Project>
    {
        ...
        {
            return _finder.FindObsolete(new FindSpecification<Project>(x => x.Id == entityId))
        ...
        protected override IDomainEntityDto<Project> CreateDto(long? parentEntityId, IEntityType parentEntityName, string extendedInfo)
        {
