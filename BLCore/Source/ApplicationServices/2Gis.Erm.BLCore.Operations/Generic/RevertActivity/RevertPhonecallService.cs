...
{
    public class RevertPhonecallService : IRevertGenericActivityService<Phonecall>
    {
        ...
        {
            using (var scope = _operationScopeFactory.CreateSpecificFor<RevertIdentity, Phonecall>())
            {
