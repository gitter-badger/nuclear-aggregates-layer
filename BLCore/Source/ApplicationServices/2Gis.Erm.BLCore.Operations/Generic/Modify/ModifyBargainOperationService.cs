...
{
    public class ModifyBargainOperationService : IModifyBusinessModelEntityService<Bargain>
    {
        ...
        public ModifyBargainOperationService(ICreateAggregateRepository<Bargain> createAggregateService,
