...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class DenialReasonIntegrationProcessorOperationService : IntegrationProcessorOperationService<DenialReason, ExportFlowOrders_DenialReason>
    {
        public DenialReasonIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<DenialReason, ExportFlowOrders_DenialReason> processingsStoreService,
            IOperationsExporter<DenialReason, ExportFlowOrders_DenialReason> operationsExporter)
