...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class LegalPersonIntegrationProcessorOperationService : IntegrationProcessorOperationService<LegalPerson, ExportFlowFinancialDataLegalEntity>
    {
        public LegalPersonIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<LegalPerson, ExportFlowFinancialDataLegalEntity> processingsStoreService,
