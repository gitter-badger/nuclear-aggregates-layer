...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class ThemeIntegrationProcessorOperationService : IntegrationProcessorOperationService<Theme, ExportFlowOrdersTheme>
    {
        public ThemeIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<Theme, ExportFlowOrdersTheme> processingsStoreService,
