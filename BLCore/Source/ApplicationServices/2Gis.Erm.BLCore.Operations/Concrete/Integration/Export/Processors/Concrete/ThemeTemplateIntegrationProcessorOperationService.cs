...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class ThemeTemplateIntegrationProcessorOperationService : IntegrationProcessorOperationService<ThemeTemplate, ExportFlowOrdersResource>
    {
        public ThemeTemplateIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<ThemeTemplate, ExportFlowOrdersResource> processingsStoreService,
