...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class PriceOperationsExportService : IntegrationProcessorOperationService<Price, ExportFlowPriceListsPriceList>
    {
        public PriceOperationsExportService(
            IOperationsProcessingsStoreService<Price, ExportFlowPriceListsPriceList> processingsStoreService, 
