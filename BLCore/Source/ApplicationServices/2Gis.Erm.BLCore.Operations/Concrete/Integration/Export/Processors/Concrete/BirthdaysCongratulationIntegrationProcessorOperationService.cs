...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class BirthdaysCongratulationIntegrationProcessorOperationService : IntegrationProcessorOperationService<BirthdayCongratulation, ExportFlowDeliveryData_LetterSendRequest>
    {
        public BirthdaysCongratulationIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<BirthdayCongratulation, ExportFlowDeliveryData_LetterSendRequest> processingsStoreService,
            IOperationsExporter<BirthdayCongratulation, ExportFlowDeliveryData_LetterSendRequest> operationsExporter) 
