...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class OrderIntegrationProcessorOperationService : IntegrationProcessorOperationService<Order, ExportFlowOrdersOrder>
    {
        public OrderIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<Order, ExportFlowOrdersOrder> processingsStoreService,
