...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class ThemeOrganizationUnitIntegrationProcessorOperationService : IntegrationProcessorOperationService<ThemeOrganizationUnit, ExportFlowOrdersThemeBranch>
    {
        public ThemeOrganizationUnitIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<ThemeOrganizationUnit, ExportFlowOrdersThemeBranch> processingsStoreService,
