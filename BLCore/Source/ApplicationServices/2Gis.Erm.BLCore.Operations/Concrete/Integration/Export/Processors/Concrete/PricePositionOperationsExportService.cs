...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class PricePositionOperationsExportService : IntegrationProcessorOperationService<PricePosition, ExportFlowPriceListsPriceListPosition>
    {
        public PricePositionOperationsExportService(
            IOperationsProcessingsStoreService<PricePosition, ExportFlowPriceListsPriceListPosition> processingsStoreService, 
