...
namespace DoubleGis.Erm.BLCore.OrderValidation.Performance.Counters
{
    public static partial class Counters
    {
        [CounterSet(CounterSetInstances.Multiple,
            Name = "Erm_OrderValidation_RuleGroups",
            Description = "Erm OrderValidation RuleGroups")]
        public enum RuleGroups
        {
            [Counter(CounterType.PerfCounterRawcount,
                DefaultScale = 1,
                Name = "Total execution time, sec",
                Description = "Rule group total execution since time after validation service host computer started",
            ...
            [Counter(CounterType.PerfCounterRawcount,
               ...
               Description = "Rule group total passed orders count since time after validation service host computer started",
               DetailLevel = CounterDetailLevel.Standard)]
            TotalOrdersCount = 2,
