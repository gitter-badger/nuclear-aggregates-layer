    ...
    this.on("beforebuild", function () {
        Ext.apply(this, {  
            Edit: function () {
                ...
                var val = this.Items.Grid.getSelectionModel().selections.items[0].data.DenialReasonId;
                ...
                var sUrl = Ext.DoubleGis.Global.Helpers.EvaluateUpdateEntityUrl('DenialReason', val, queryString);
