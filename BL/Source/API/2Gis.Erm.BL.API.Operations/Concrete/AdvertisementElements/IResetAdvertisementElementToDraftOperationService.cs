...
{
    public interface IResetAdvertisementElementToDraftOperationService : IOperation<ResetAdvertisementElementToDraftIdentity>,
                                                                         IAdvertisementElementStatusChangingStrategy
    {
        int ResetToDraft(AdvertisementElementStatus currentStatus);
    }
}