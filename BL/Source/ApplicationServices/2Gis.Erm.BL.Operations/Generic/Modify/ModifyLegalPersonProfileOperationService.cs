...
{
    public sealed class ModifyLegalPersonProfileOperationService : IModifyBusinessModelEntityService<LegalPersonProfile>
    {
        ...
        public ModifyLegalPersonProfileOperationService(
