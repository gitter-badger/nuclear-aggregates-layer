...
{
    public class AdvertisementElementStatusBehaviourReadyForValidation : AdvertisementElementStatusBehaviour
    {
        ...
        public AdvertisementElementStatusBehaviourReadyForValidation(
