...
WriteAttribute("src", Tuple.Create(" src=\"", 338), Tuple.Create("\"", 383)
, Tuple.Create(Tuple.Create("", 344), Tuple.Create("/Scripts/Tooltip.js?", 344), true)
            
            #line 13 "..\..\Views\Print\ChooseProfile.cshtml"
, Tuple.Create(Tuple.Create("", 364), Tuple.Create<System.Object, System.Int32>(ThisAssembly.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 430), Tuple.Create("\"", 496)
, Tuple.Create(Tuple.Create("", 436), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 436), true)
...
WriteAttribute("onmouseover", Tuple.Create(" \r\n                             onmouseover=\"", 2123), Tuple.Create("\"", 2195)
, Tuple.Create(Tuple.Create("", 2168), Tuple.Create("AddTooltip(", 2168), true)
            
            #line 55 "..\..\Views\Print\ChooseProfile.cshtml"
, Tuple.Create(Tuple.Create("", 2179), Tuple.Create<System.Object, System.Int32>(Model.Message
            
            #line default
            #line hidden
, 2179), false)
, Tuple.Create(Tuple.Create("", 2193), Tuple.Create(");", 2193), true)
);
