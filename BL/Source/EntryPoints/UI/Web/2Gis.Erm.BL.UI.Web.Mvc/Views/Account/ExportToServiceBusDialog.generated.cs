...
"\n\r\n\r\n            // show error messages\r\n            if (Ext.getDom(\"Notificatio" +
"ns\").innerHTML.trim() != \"\") {\r\n                Ext.get(\"Notifications\").addClas" +
"s(\"Notifications\");\r\n            }\r\n            else {\r\n                Ext.get(" +
"\"Notifications\").removeClass(\"Notifications\");\r\n            }\r\n\r\n            Ext" +
".get(\"Cancel\").on(\"click\", function () { window.close(); });\r\n            Ext.ge" +
"t(\"OK\").on(\"click\", function () {\r\n                if (Ext.DoubleGis.FormValidat" +
"or.validate(EntityForm)) {\r\n                    Ext.getDom(\"OK\").disabled = \"dis" +
"abled\";\r\n                    Ext.getDom(\"Cancel\").disabled = \"disabled\";\r\n      " +
"              window.Ext.each(window.Ext.query(\"input.x-calendar\", window.Entity" +
"Form), function (node) {\r\n                        node.value = window.Ext.getCmp" +
"(node.id).getValue() ? new Date(window.Ext.getCmp(node.id).getValue()).format(Ex" +
"t.CultureInfo.DateTimeFormatInfo.PhpInvariantDateTimePattern) : \"\";\r\n           " +
"         });\r\n                    EntityForm.submit();\r\n                }\r\n     " +
"       });\r\n        });\r\n    </script>\r\n\r\n");
...
WriteAttribute("value", Tuple.Create(" value=\"", 2534), Tuple.Create("\"", 2555)
            
            #line 69 "..\..\Views\Account\ExportToServiceBusDialog.cshtml"
, Tuple.Create(Tuple.Create("", 2542), Tuple.Create<System.Object, System.Int32>(Model.FileId
...
WriteLiteral(" />\r\n");
            ...
            #line 70 "..\..\Views\Account\ExportToServiceBusDialog.cshtml"
            }
...
WriteLiteral("    </div>\r\n\r\n");
            ...
            #line 82 "..\..\Views\Account\ExportToServiceBusDialog.cshtml"
...
WriteLiteral("\r\n            </div>\r\n        </div>\r\n");
            ...
            #line 108 "..\..\Views\Account\ExportToServiceBusDialog.cshtml"
    }
