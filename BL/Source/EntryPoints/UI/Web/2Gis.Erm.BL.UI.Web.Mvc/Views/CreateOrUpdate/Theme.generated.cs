...
namespace DoubleGis.Erm.BL.UI.Web.Mvc.Views.CreateOrUpdate
{
    ...
    public partial class Theme : System.Web.Mvc.WebViewPage<ThemeViewModel>
    {
        public Theme()
        {
        }
...
, Tuple.Create(Tuple.Create("", 122), Tuple.Create("/Scripts/Ext.DoubleGis.UI.Theme.js?", 122), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 514), Tuple.Create("\"", 550)
            
            #line 20 "..\..\Views\CreateOrUpdate\Theme.cshtml"
, Tuple.Create(Tuple.Create("", 522), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
...
WriteLiteral("            ");
       ...
       Write(Html.TemplateField(m => m.ThemeTemplate, FieldFlex.twins, new LookupSettings { EntityName = EntityType.Instance.ThemeTemplate() }));
...
WriteAttribute("alt", Tuple.Create(" alt=\"", 2047), Tuple.Create("\"", 2079)
            
            #line 43 "..\..\Views\CreateOrUpdate\Theme.cshtml"
, Tuple.Create(Tuple.Create("", 2053), Tuple.Create<System.Object, System.Int32>(BLResources.UploadedImage
