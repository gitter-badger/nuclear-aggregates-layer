...
WriteAttribute("title", Tuple.Create(" title=\"", 1268), Tuple.Create("\"", 1304)
            
            #line 31 "..\..\Views\CreateOrUpdate\Letter.cshtml"
, Tuple.Create(Tuple.Create("", 1276), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
...
WriteLiteral("        ");
   ...
   Write(Html.SectionRow(@Html.TemplateField(m => m.Recipient, FieldFlex.lone, new LookupSettings { EntityName = EntityName.Contact, ClientInitialization = Model.RecipientClientInitialization, ExtendedInfo = "ForClientAndLinkedChild=true", ParentEntityName = EntityName.Client, ParentIdPattern = "ClientId" })));
