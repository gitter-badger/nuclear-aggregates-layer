...
{
    public sealed class CyprusLegalPersonProfileViewModel : EntityViewModelBase<LegalPersonProfile>, ILegalPersonProfileViewModel, ICustomizableLegalPersonProfileViewModel, ICyprusAdapted
    {
        [RequiredLocalized]
