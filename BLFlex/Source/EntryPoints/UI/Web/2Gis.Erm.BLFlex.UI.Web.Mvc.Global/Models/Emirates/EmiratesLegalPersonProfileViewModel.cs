...
{
    public sealed class EmiratesLegalPersonProfileViewModel : EntityViewModelBase<LegalPersonProfile>, ILegalPersonProfileViewModel, ICustomizableLegalPersonProfileViewModel, IEmiratesAdapted
    {
        [RequiredLocalized]
