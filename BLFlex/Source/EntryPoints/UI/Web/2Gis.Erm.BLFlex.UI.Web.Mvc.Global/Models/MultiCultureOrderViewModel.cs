...
{
    public sealed class MultiCultureOrderViewModel : EntityViewModelBase<Order>, ICustomizableOrderViewModel, ICzechAdapted, ICyprusAdapted, IChileAdapted, IUkraineAdapted, IEmiratesAdapted, IKazakhstanAdapted
    {
