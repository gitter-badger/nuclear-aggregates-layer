...
{
    public sealed class LegalPersonProfileViewModel : EntityViewModelBase<LegalPersonProfile>, ILegalPersonProfileViewModel, ICustomizableLegalPersonProfileViewModel, IRussiaAdapted
    {
        [SanitizedString]
        [RequiredLocalized]
