...
WriteAttribute("href", Tuple.Create(" href=\"", 420), Tuple.Create("\"", 466)
...
WriteAttribute("src", Tuple.Create(" src=\"", 489), Tuple.Create("\"", 562)
, Tuple.Create(Tuple.Create("", 495), Tuple.Create("/Scripts/Chile/Ext.DoubleGis.UI.BillPayments.js?", 495), true)
...
WriteAttribute("src", Tuple.Create(" src=\"", 609), Tuple.Create("\"", 667)
, Tuple.Create(Tuple.Create("", 615), Tuple.Create("/Scripts/Ext.grid.CheckColumn.js?", 615), true)
