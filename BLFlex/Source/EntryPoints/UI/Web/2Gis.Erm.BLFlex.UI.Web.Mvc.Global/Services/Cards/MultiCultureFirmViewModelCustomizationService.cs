...
{
    public class MultiCultureFirmViewModelCustomizationService : IGenericViewModelCustomizationService<Firm>, ICyprusAdapted, IChileAdapted, ICzechAdapted, IUkraineAdapted, IEmiratesAdapted
    {
