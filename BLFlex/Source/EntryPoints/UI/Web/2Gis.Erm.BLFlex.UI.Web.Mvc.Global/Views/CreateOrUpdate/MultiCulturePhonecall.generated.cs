...
WriteAttribute("src", Tuple.Create(" src=\"", 171), Tuple.Create("\"", 228)
...
, Tuple.Create(Tuple.Create("", 209), Tuple.Create<System.Object, System.Int32>(ThisAssembly.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 275), Tuple.Create("\"", 342)
, Tuple.Create(Tuple.Create("", 281), Tuple.Create("/Scripts/Ext.DoubleGis.UI.ActivityBase.js?", 281), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 559), Tuple.Create("\"", 595)
            
            #line 21 "..\..\Views\CreateOrUpdate\MultiCulturePhonecall.cshtml"
, Tuple.Create(Tuple.Create("", 567), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
