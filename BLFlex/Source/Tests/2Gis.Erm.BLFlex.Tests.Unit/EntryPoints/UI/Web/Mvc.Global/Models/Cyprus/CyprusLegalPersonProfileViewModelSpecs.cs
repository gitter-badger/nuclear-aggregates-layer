...
{
    public class CyprusLegalPersonProfileViewModelSpecs
    {
        [Tags("ViewModel")]
        [Subject(typeof(CyprusLegalPersonProfileViewModel))]
        public class When_loading_domain_entity_dto
        {
            static CyprusLegalPersonProfileViewModel Target;
            static LegalPersonProfileDomainEntityDto DomainEntityDto;

            Establish context = () =>
            {
                Target = new CyprusLegalPersonProfileViewModel();
                DomainEntityDto = new LegalPersonProfileDomainEntityDto();
                LegalPersonViewProfileModelsTestHelper.FillCyprusLegalPersonProfileDtoWithTestData(DomainEntityDto);
            };
            ...
            It should_have_expected_IBAN = () => Target.IBAN.Should().Be(LegalPersonViewProfileModelsTestHelper.TestIBAN);
            It should_have_expected_SWIFT = () => Target.SWIFT.Should().Be(LegalPersonViewProfileModelsTestHelper.TestSWIFT);
            ...
            It should_have_expected_RegistrationCertificateNumber = () => Target.RegistrationCertificateNumber.Should().Be(LegalPersonViewProfileModelsTestHelper.TestRegistrationCertificateNumber);
            It should_have_expected_RegistrationCertificateDate = () => Target.RegistrationCertificateDate.Should().Be(LegalPersonViewProfileModelsTestHelper.TestRegistrationCertificateDate);
        ...
        public class When_transforming_to_domain_entity_dto
        {
            ...
            Establish context = () =>
                {
                    Target = new CyprusLegalPersonProfileViewModel();
                    LegalPersonViewProfileModelsTestHelper.FillCyprusViewModelWithTestData(Target);
                };
            ...
            It should_have_expected_IBAN = () => DomainEntityDto.IBAN.Should().Be(LegalPersonViewProfileModelsTestHelper.TestIBAN);
            It should_have_expected_SWIFT = () => DomainEntityDto.SWIFT.Should().Be(LegalPersonViewProfileModelsTestHelper.TestSWIFT);
            ...
            It should_have_expected_RegistrationCertificateNumber = () => DomainEntityDto.RegistrationCertificateNumber.Should().Be(LegalPersonViewProfileModelsTestHelper.TestRegistrationCertificateNumber);
            It should_have_expected_RegistrationCertificateDate = () => DomainEntityDto.RegistrationCertificateDate.Should().Be(LegalPersonViewProfileModelsTestHelper.TestRegistrationCertificateDate);
