...
namespace DoubleGis.Erm.BLFlex.Tests.Unit.ApplicationServices.Operations.Global.Chile.Generic
{
    public static class OrderPrintFormDataExtractorSpecs
    {
        ...
        static readonly Order Order = new Order { BranchOfficeOrganizationUnit = BranchOfficeOrganizationUnit, DestOrganizationUnit = OrganizationUnit, Firm = Firm, Bargain = Bargain, SourceOrganizationUnit = OrganizationUnit, BeginDistributionDate = DateTime.Now, ReleaseCountPlan = 1 };
        ...
        public class WhenRequestingChileanPrintData
        {
            ...
            static readonly string[] RootFieldSet = 
                {
                    ...
                    "BranchOfficeOrganizationUnitPart.RepresentativeRut",
                    "Categories",
                    "ElectronicMedia",
                    "Firm.Name",
                    "FirmAddresses",
                    ...
                    "Profile.PositionInNominative",
                    "ProfilePart.AccountType",
                    "ProfilePart.BankName",
                    "ProfilePart.RepresentativeAuthorityDocumentIssuedBy",
                    "ProfilePart.RepresentativeAuthorityDocumentIssuedOn",
            ...
            Because of = () =>
            {
                Result = PrintData.Concat(DataExtractor.GetBranchOffice(Query(BranchOffice)),
                                          ...
                                          DataExtractor.GetBranchOfficeOrganizationUnit(BranchOfficeOrganizationUnit, BranchOfficeOrganizationUnitPart),
                                          DataExtractor.GetLegalPerson(LegalPerson),
                                          DataExtractor.GetLegalPersonProfile(LegalPersonProfile, LegalPersonProfilePart, Bank));
            };
