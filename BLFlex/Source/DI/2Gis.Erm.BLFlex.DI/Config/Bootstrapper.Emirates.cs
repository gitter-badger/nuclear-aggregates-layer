...
using DoubleGis.Erm.BLFlex.Operations.Global.Emirates.Concrete;
...
namespace DoubleGis.Erm.BLFlex.DI.Config
{
    public static partial class Bootstrapper
    {
        ...
        {
            return container
                .RegisterType<IOrderNumberTemplatesProvider, EmiratesOrderNumberTemplatesProvider>(Lifetime.Singleton)
