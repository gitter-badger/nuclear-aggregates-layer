...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Russia.Concrete.Orders.Print
{
    public class PrintCancellationAgreementOperationService : IPrintCancellationAgreementOperationService, IRussiaAdapted
    {
        ...
        private PrintDocumentRequest CreateRequest(long orderId)
        {
            ...
            var requisites = GetRequisites(legalPerson, legalPersonProfile, branchOffice, branchOfficeOrganizationUnit);
        ...
        private PrintData GetRequisites(LegalPerson legalPerson, LegalPersonProfile legalPersonProfile, BranchOffice branchOffice, BranchOfficeOrganizationUnit branchOfficeOrganizationUnit)
        {
            return PrintData.Concat(PrintHelper.DetermineRequisitesType(legalPerson.LegalPersonTypeEnum),
