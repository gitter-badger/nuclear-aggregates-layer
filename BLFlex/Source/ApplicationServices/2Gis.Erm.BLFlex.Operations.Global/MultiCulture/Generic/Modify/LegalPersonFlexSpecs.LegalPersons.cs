    ...
    public partial class LegalPersonFlexSpecs
    {
        public static class LegalPersons
        {
            public static class MultiCulture
            {
                ...
                {
                    public static IProjectSpecification<LegalPerson, LegalPersonDomainEntityDto> DomainEntityDto()
                    {
                        return new ProjectSpecification<LegalPerson, LegalPersonDomainEntityDto>(
                            x =>
                                {
                                    if (x.IsNew())
                                    {
