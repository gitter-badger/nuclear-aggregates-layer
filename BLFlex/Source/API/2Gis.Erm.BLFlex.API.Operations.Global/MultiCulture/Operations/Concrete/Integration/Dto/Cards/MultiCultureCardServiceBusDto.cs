...
{
    public sealed class MultiCultureCardServiceBusDto : CardServiceBusDto, IRussiaAdapted, IChileAdapted, ICyprusAdapted, ICzechAdapted, IUkraineAdapted, IKazakhstanAdapted
    {
