...
$Properties.SemanticVersion = '2.94.0'
...
Import-Module "$($Properties.SolutionDir)\packages\2GIS.NuClear.BuildTools.0.0.35\tools\buildtools.psm1" -DisableNameChecking -Force
