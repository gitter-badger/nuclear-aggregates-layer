...
namespace DoubleGis.Erm.Model.Entities.Erm
{
    ...
    [KnownType(typeof(PerformedBusinessOperation))]
      ...
      public sealed partial class ExportFlowOrders_Order: 
        ...
        private void FixupPerformedBusinessOperation(PerformedBusinessOperation previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.ExportFlowOrders_Order, this))
            {
                previousValue.ExportFlowOrders_Order = null;
            }
    
            if (PerformedBusinessOperation != null)
            {
                PerformedBusinessOperation.ExportFlowOrders_Order = this;
