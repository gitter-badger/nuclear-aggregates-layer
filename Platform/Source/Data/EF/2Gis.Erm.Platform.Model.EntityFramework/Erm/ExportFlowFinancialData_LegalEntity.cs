...
namespace DoubleGis.Erm.Model.Entities.Erm
{
    ...
    [KnownType(typeof(PerformedBusinessOperation))]
      ...
      public sealed partial class ExportFlowFinancialData_LegalEntity: 
        ...
        private void FixupPerformedBusinessOperation(PerformedBusinessOperation previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.ExportFlowFinancialData_LegalEntity, this))
            {
                previousValue.ExportFlowFinancialData_LegalEntity = null;
            }
    
            if (PerformedBusinessOperation != null)
            {
                PerformedBusinessOperation.ExportFlowFinancialData_LegalEntity = this;
