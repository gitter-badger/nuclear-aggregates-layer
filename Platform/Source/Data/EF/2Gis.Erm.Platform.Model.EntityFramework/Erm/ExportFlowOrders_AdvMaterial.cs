...
namespace DoubleGis.Erm.Model.Entities.Erm
{
    ...
    [KnownType(typeof(PerformedBusinessOperation))]
      ...
      public sealed partial class ExportFlowOrders_AdvMaterial: 
        ...
        private void FixupPerformedBusinessOperation(PerformedBusinessOperation previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.ExportFlowOrders_AdvMaterial, this))
            {
                previousValue.ExportFlowOrders_AdvMaterial = null;
            }
    
            if (PerformedBusinessOperation != null)
            {
                PerformedBusinessOperation.ExportFlowOrders_AdvMaterial = this;
