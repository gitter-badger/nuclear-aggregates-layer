...
namespace DoubleGis.Erm.Platform.Common.Utils
{
    ...
    public class CompareObjects
    {
        ...
        /// <summary>
        /// Extensions for ElementToIgnore with wildcards
        /// </summary>
        private IEnumerable<Wildcard> _elementToIgnoreWildcards; 
        ...
        public List<string> ElementsToIgnore
        {
            ...
            set
            {
                ...
                _elementToIgnoreWildcards = _elementsToIgnore.Select(element => new Wildcard(element)).ToArray();
            }
        }
        ...
        private void Compare(object object1, object object2, string breadCrumb)
        {
            ...
            if (object1 == null)
            {
                ...
                AddToDifferenceMap(breadCrumb, object1, object2);
                return;
            }
            ...
            if (t1 != t2)
            {
                ...
                AddToDifferenceMap(breadCrumb, object1.GetType(), object2.GetType());
                return;
            }
        ...
        private void CompareDataTable(object object1, object object2, string breadCrumb)
        {
            ...
            if (dataTable1.Rows.Count != dataTable2.Rows.Count)
            {
                ...
                AddToDifferenceMap(string.Format("{0}.Rows.Count", breadCrumb), dataTable1.Rows.Count, dataTable2.Rows.Count);
            ...
            if (dataTable1.Columns.Count != dataTable2.Columns.Count)
            {
                ...
                AddToDifferenceMap(string.Format("{0}.Columns.Count", breadCrumb), dataTable1.Columns.Count, dataTable2.Columns.Count);
        ...
        private void CompareDataset(object object1, object object2, string breadCrumb)
        {
            ...
            if (dataSet1.Tables.Count != dataSet2.Tables.Count)
            {
                ...
                AddToDifferenceMap(string.Format("{0}.Tables.Count", breadCrumb), dataSet1.Tables.Count, dataSet2.Tables.Count);
        ...
        private void CompareTimespan(object object1, object object2, string breadCrumb)
        {
            if (((TimeSpan)object1).Ticks != ((TimeSpan)object2).Ticks)
            {
                ...
                AddToDifferenceMap(string.Format("{0}.Ticks", breadCrumb), ((TimeSpan)object1).Ticks, ((TimeSpan)object2).Ticks);
        ...
        private void CompareIndexer(PropertyInfo info, object object1, object object2, string breadCrumb)
        {
            ...
            if (indexerCount1 != indexerCount2)
            {
                ...
                AddToDifferenceMap(string.Format("{0}.Count", breadCrumb), indexerCount1, indexerCount2);
        ...
        private void CompareIDictionary(object object1, object object2, string breadCrumb)
        {
            ...
            try
            {
                ...
                if (iDict1.Count != iDict2.Count)
                {
                    ...
                    AddToDifferenceMap(string.Format("{0}.Count", breadCrumb), iDict1.Count, iDict2.Count);
        ...
        private void CompareIList(object object1, object object2, string breadCrumb)
        {
            ...
            try
            {
                ...
                if (ilist1.Count != ilist2.Count)
                {
                    ...
                    AddToDifferenceMap(string.Format("{0}.Count", breadCrumb), ilist1.Count, ilist2.Count);
        ...
        private void AddToDifferenceMap(string breadCrumb, object object1, object object2)
        {
