...
namespace DoubleGis.Platform.UI.WPF.Infrastructure.Util.FocusableBinding
{
    ...
    public abstract class BindingDecoratorBase : MarkupExtension
    {
        ...
        /// <param name="property">The target property of the binding.</param>
        /// <returns>True if the provider supports all that's needed.</returns>
        protected virtual bool TryGetTargetItems(IServiceProvider provider, out DependencyObject target, out string property)
        {
            target = null;
            property = null;
