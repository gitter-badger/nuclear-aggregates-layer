...
namespace DoubleGis.Erm.Platform.Core.UseCases.Context
{
    /// <summary>
    /// Хранилище данных, где с типизированными ключами сопоставлены значения
    /// Чтобы поместить что-то в контекст или получить что-то оттуда, нужно знать instance класса, который реализует маркерный интерфейс <see cref="IContextKey{T}"/>
    /// </summary>
