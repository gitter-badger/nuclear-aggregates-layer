...
namespace DoubleGis.Erm.BLCore.ExtractUseCases.Generated.UseCases
{
        ...
        new UseCaseNode(1)
        {
            ...
            Request = typeof(ValidatePaymentRequisitesIsUniqueRequest)
                ...
                new UseCase
                {
                    ...
                    Root = new UseCaseNode(0)
                    {
                        ContainingClass = typeof(EditBranchOfficeOrganizationUnitHandler),
                        Request = typeof(EditRequest<BranchOfficeOrganizationUnit>)
                    }
                },
                new UseCase
                {
                        ...
                        ChildNodes = new[]
    {
        ...
        new UseCaseNode(1)
        {
            ContainingClass = typeof(ExportAccountDetailsTo1CForBranchHandler),
            Request = typeof(ExportAccountDetailsTo1CForBranchRequest),
            ChildNodes = new[]
            {
                new UseCaseNode(2)
                {
                        ...
                        ChildNodes = new[]
    {
        new UseCaseNode(1)
        {
            ...
            Request = typeof(ValidatePaymentRequisitesIsUniqueRequest)
                ...
                new UseCase
                {
                    Description = @"PublicService_Explicitly. DoubleGis.Erm.UI.Web.Mvc.Controllers.AccountController\ExportTo1CDialog",
                    MaxUseCaseDepth = 1,
                    Root = new UseCaseNode(0)
                    {
                        ContainingClass = typeof(ExportAccountDetailsTo1CForFranchiseesHandler),
                        Request = typeof(ExportAccountDetailsTo1CForFranchiseesRequest),
                        ChildNodes = new[]
    {
        new UseCaseNode(1)
        {
