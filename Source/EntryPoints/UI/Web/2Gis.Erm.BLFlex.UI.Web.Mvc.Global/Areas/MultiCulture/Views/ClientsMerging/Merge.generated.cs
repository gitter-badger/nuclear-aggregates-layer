...
WriteAttribute("src", Tuple.Create(" src=\"", 358), Tuple.Create("\"", 423)
...
WriteAttribute("src", Tuple.Create(" src=\"", 470), Tuple.Create("\"", 561)
, Tuple.Create(Tuple.Create("", 476), Tuple.Create("/Scripts/MultiCulture/MergeClients.MultiCulture.js?", 476), true)
            
            #line 14 "..\..\Areas\MultiCulture\Views\ClientsMerging\Merge.cshtml"
, Tuple.Create(Tuple.Create("", 527), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
