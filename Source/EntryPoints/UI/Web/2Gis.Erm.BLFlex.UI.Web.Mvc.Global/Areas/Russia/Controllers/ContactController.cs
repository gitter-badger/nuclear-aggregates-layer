...
namespace DoubleGis.Erm.BLFlex.UI.Web.Mvc.Global.Areas.Russia.Controllers
{
    ...
    // лучше передавать прямо во ViewModel, в виде map и использовать в js без дополнительных запросов на сервер, кастомизациия под бизнес модель достигается через IAdapted ViewModelCustomizationService
    [Obsolete]
