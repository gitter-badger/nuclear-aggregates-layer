...
WriteAttribute("src", Tuple.Create(" src=\"", 353), Tuple.Create("\"", 418)
...
, Tuple.Create(Tuple.Create("", 384), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 465), Tuple.Create("\"", 544)
, Tuple.Create(Tuple.Create("", 471), Tuple.Create("/Scripts/Russia/MergeClients.Russia.js?", 471), true)
