...
WriteAttribute("src", Tuple.Create(" src=\"", 363), Tuple.Create("\"", 428)
...
, Tuple.Create(Tuple.Create("", 394), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 475), Tuple.Create("\"", 558)
, Tuple.Create(Tuple.Create("", 481), Tuple.Create("/Scripts/Emirates/MergeClients.Emirates.js?", 481), true)
