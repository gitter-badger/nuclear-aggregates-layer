...
{
    public class MultiCultureAppointmentViewModelCustomizationService : IGenericViewModelCustomizationService<Appointment>, ICyprusAdapted, ICzechAdapted, IChileAdapted
    {
