...
{
    public sealed class MultiCultureIntegrationTypeImportEnumCustomization : EnumCustomizationBase<IntegrationTypeImport>, IChileAdapted, ICyprusAdapted, ICzechAdapted, IUkraineAdapted
    {
