...
WriteAttribute("src", Tuple.Create(" src=\"", 132), Tuple.Create("\"", 189)
...
, Tuple.Create(Tuple.Create("", 170), Tuple.Create<System.Object, System.Int32>(ThisAssembly.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 236), Tuple.Create("\"", 316)
, Tuple.Create(Tuple.Create("", 242), Tuple.Create("/Scripts/Russia/Ext.DoubleGis.UI.RussiaActivityBase.js?", 242), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 533), Tuple.Create("\"", 569)
            
            #line 20 "..\..\Views\CreateOrUpdate\Russia\Task.cshtml"
, Tuple.Create(Tuple.Create("", 541), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
