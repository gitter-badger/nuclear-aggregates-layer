...
WriteAttribute("src", Tuple.Create(" src=\"", 138), Tuple.Create("\"", 210)
...
WriteAttribute("src", Tuple.Create(" src=\"", 264), Tuple.Create("\"", 338)
, Tuple.Create(Tuple.Create("", 270), Tuple.Create("/Scripts/Ext.DoubleGis.UI.Bill.js?", 270), true)
