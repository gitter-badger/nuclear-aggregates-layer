            ...
            window.Card.on(""beforebuild"", function(card) {
                Ext.apply(this, {
                    ...
                    ChangeLegalPersonRequisites: function() {
                        ...
                        var url = '/Czech/LegalPerson/CzechChangeLegalPersonRequisites/' + Ext.getDom(""Id"").value;
...
WriteAttribute("title", Tuple.Create(" title=\"", 5884), Tuple.Create("\"", 5920)
            
            #line 123 "..\..\Views\CreateOrUpdate\CzechLegalPerson.cshtml"
, Tuple.Create(Tuple.Create("", 5892), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
