            ...
            window.Card.on(""beforebuild"", function(card) {
                Ext.apply(this, {
                    ...
                    ChangeLegalPersonRequisites: function() {
                        ...
                        var url = '/Cyprus/LegalPerson/CyprusChangeLegalPersonRequisites/' + Ext.getDom(""Id"").value;
...
WriteAttribute("title", Tuple.Create(" title=\"", 5904), Tuple.Create("\"", 5940)
            
            #line 124 "..\..\Views\CreateOrUpdate\CyprusLegalPerson.cshtml"
, Tuple.Create(Tuple.Create("", 5912), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
