...
WriteAttribute("src", Tuple.Create(" src=\"", 188), Tuple.Create("\"", 269)
...
WriteAttribute("src", Tuple.Create(" src=\"", 316), Tuple.Create("\"", 415)
, Tuple.Create(Tuple.Create("", 322), Tuple.Create("/Scripts/Emirates/Ext.DoubleGis.UI.LegalPerson.Emirates.js?", 322), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 713), Tuple.Create("\"", 749)
            
            #line 24 "..\..\Views\CreateOrUpdate\Emirates\LegalPerson.cshtml"
, Tuple.Create(Tuple.Create("", 721), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
