...
namespace DoubleGis.Erm.BL.UI.Web.Mvc.Views.CreateOrUpdate
{
    ...
    public partial class Phonecall : System.Web.Mvc.WebViewPage<Models.PhonecallViewModel>
    {
        public Phonecall()
        {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 129), Tuple.Create("\"", 201)
, Tuple.Create(Tuple.Create("", 135), Tuple.Create("/Scripts/Ext.ux.TimeComboBox.js?", 135), true)
            
            #line 10 "..\..\Views\CreateOrUpdate\Phonecall.cshtml"
, Tuple.Create(Tuple.Create("", 167), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 248), Tuple.Create("\"", 330)
, Tuple.Create(Tuple.Create("", 254), Tuple.Create("/Scripts/Ext.DoubleGis.UI.ActivityBase.js?", 254), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 556), Tuple.Create("\"", 592)
            
            #line 22 "..\..\Views\CreateOrUpdate\Phonecall.cshtml"
, Tuple.Create(Tuple.Create("", 564), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
