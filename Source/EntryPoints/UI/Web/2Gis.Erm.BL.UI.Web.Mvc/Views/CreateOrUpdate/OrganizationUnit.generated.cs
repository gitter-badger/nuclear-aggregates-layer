...
"}\',\r\n                        \'/Grid/View/UserOrganizationUnit/null\',\r\n          " +
"              this.form.Id.value,\r\n                        this.ReadOnly ? \'Inac" +
"tive\' : \'Active\');\r\n                    var requestParametrs = { extendedInfo: \'" +
"orgUnitId=\' + this.form.Id.value, singleDataView: \'DListUsersInOrganizationUnit\'" +
" };\r\n                    iframe.dom.src = Ext.urlAppend(frameUrl, Ext.urlEncode(" +
"requestParametrs));\r\n\r\n                    iframe.on(\'load\', function(evt, el) {" +
"\r\n                        el.height = Ext.get(el.parentElement).getComputedHeigh" +
"t();\r\n                        el.width = Ext.get(el.parentElement).getComputedWi" +
"dth();\r\n                        el.style.height = \"100%\";\r\n                     " +
"   el.style.width = \"100%\";\r\n                        el.contentWindow.Ext.onRead" +
"y(function() {\r\n                            el.contentWindow.IsBottomOrderPositi" +
"onDataList = true;\r\n                        });\r\n                        this.hi" +
"de();\r\n                    }, mask);\r\n                    cnt.doLayout();\r\n     " +
...
"rganizationUnitId == 0) {\r\n                        Ext.MessageBox.show({\r\n      " +
"                      title: \'\',\r\n                            msg: Ext.Localized" +
"Resources.CardIsNewAlert,\r\n                            buttons: Ext.MessageBox.O" +
"K,\r\n                            icon: Ext.MessageBox.ERROR\r\n                    " +
"    });\r\n                        return;\r\n                    }\r\n\r\n             " +
"       var url = \'/CategoryGroupsMembership/Manage?organizationUnitId={0}\';\r\n\r\n " +
"                   var params = String.format(\"width={0},height={1},status=no,re" +
"sizable=yes,top={2},left={3},scroll=no\",\r\n                        window.Ext.Dou" +
"bleGis.Global.UISettings.ActualCardWidth, window.Ext.DoubleGis.Global.UISettings" +
".ActualCardHeight,\r\n                        window.Ext.DoubleGis.Global.UISettin" +
"gs.ScreenCenterTop, window.Ext.DoubleGis.Global.UISettings.ScreenCenterLeft);\r\n\r" +
"\n                    window.open(String.format(url, organizationUnitId), \"_blank" +
"\", params);\r\n                }\r\n            });\r\n\r\n            this.on(\"afterbui" +
...
WriteAttribute("title", Tuple.Create(" title=\"", 5006), Tuple.Create("\"", 5045)
            
            #line 114 "..\..\Views\CreateOrUpdate\OrganizationUnit.cshtml"
, Tuple.Create(Tuple.Create("", 5014), Tuple.Create<System.Object, System.Int32>(BLResources.AdditionalTabTitle
