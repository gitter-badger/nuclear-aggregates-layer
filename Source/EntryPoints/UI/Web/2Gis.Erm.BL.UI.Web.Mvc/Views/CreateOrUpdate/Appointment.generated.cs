...
namespace DoubleGis.Erm.BL.UI.Web.Mvc.Views.CreateOrUpdate
{
    ...
    public partial class Appointment : System.Web.Mvc.WebViewPage<Models.AppointmentViewModel>
    {
        public Appointment()
        {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 131), Tuple.Create("\"", 203)
, Tuple.Create(Tuple.Create("", 137), Tuple.Create("/Scripts/Ext.ux.TimeComboBox.js?", 137), true)
            
            #line 10 "..\..\Views\CreateOrUpdate\Appointment.cshtml"
, Tuple.Create(Tuple.Create("", 169), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 250), Tuple.Create("\"", 332)
, Tuple.Create(Tuple.Create("", 256), Tuple.Create("/Scripts/Ext.DoubleGis.UI.ActivityBase.js?", 256), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 558), Tuple.Create("\"", 594)
            
            #line 22 "..\..\Views\CreateOrUpdate\Appointment.cshtml"
, Tuple.Create(Tuple.Create("", 566), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
