...
"\").on(\'change\', function() {\r\n                var profileId = Ext.getCmp(\"LegalP" +
"ersonProfile\").getValue().id;\r\n                var defaultProfileId = Ext.getDom" +
"(\"DefaultLegalPersonProfileId\").value;\r\n                if (profileId != default" +
"ProfileId) {\r\n                    Ext.getDom(\"warning\").style.visibility = \'visi" +
"ble\';\r\n                } else {\r\n                    Ext.getDom(\"warning\").style" +
".visibility = \'hidden\';\r\n                }\r\n            })\r\n            Ext.get(" +
"\"Cancel\").on(\"click\", function() { window.close(); });\r\n            Ext.get(\"OK\"" +
").on(\"click\", function() {\r\n                if (Ext.DoubleGis.FormValidator.vali" +
"date(EntityForm)) {\r\n\r\n                    var orderId = Ext.getDom(\'OrderId\').v" +
"alue;\r\n                    var methodName = Ext.getDom(\'PrintOrderType\').value;\r" +
"\n                    var profileId = Ext.getCmp(\"LegalPersonProfile\").getValue()" +
".id;\r\n\r\n                    url = \'/Order/\' + methodName + \'/\' + orderId + \'?pro" +
"fileId=\' + profileId + \'&__dc=\' + Ext.util.Format.cacheBuster();\r\n\r\n            " +
"        Ext.getDom(\"OK\").disabled = true;\r\n                    Ext.getDom(\"Cance" +
"l\").disabled = true;\r\n\r\n                    var iframe;\r\n                    ifr" +
"ame = document.getElementById(\"hiddenDownloader\");\r\n                    if (ifra" +
"me === null) {\r\n                        iframe = document.createElement(\'iframe\'" +
");\r\n                        iframe.id = \"hiddenDownloader\";\r\n                   " +
"     iframe.style.visibility = \'hidden\';\r\n\r\n                        var iframeEl" +
" = new Ext.Element(iframe);\r\n                        iframeEl.on(\"load\", functio" +
"n() {\r\n                            var iframeContent = iframe.contentWindow.docu" +
"ment.documentElement.innerText;\r\n                            if (iframeContent !" +
"= \"\") {\r\n                                alert(iframeContent);\r\n                " +
"            }\r\n                        });\r\n                        document.bod" +
...
"        });\r\n    </script>\r\n    \r\n");
            ...
            #line 66 "..\..\Views\Order\Print.cshtml"
...
WriteAttribute("onmouseover", Tuple.Create(" \r\n                             onmouseover=\"", 3395), Tuple.Create("\"", 3467)
, Tuple.Create(Tuple.Create("", 3440), Tuple.Create("AddTooltip(", 3440), true)
            
            #line 77 "..\..\Views\Order\Print.cshtml"
, Tuple.Create(Tuple.Create("", 3451), Tuple.Create<System.Object, System.Int32>(Model.Message
            
            #line default
            #line hidden
, 3451), false)
, Tuple.Create(Tuple.Create("", 3465), Tuple.Create(");", 3465), true)
);
...
WriteLiteral("                            ");
            ...
            #line 79 "..\..\Views\Order\Print.cshtml"
                       Write(Model.Message);
...
WriteLiteral("                                        ");
            ...
            #line 90 "..\..\Views\Order\Print.cshtml"
...
"");
            ...
            #line 114 "..\..\Views\Order\Print.cshtml"
