...
", function () { window.close(); });\r\n            Ext.get(\"OK\").on(\"click\", submi" +
"tForm);\r\n\r\n            Ext.get(\"CloseReason\").on(\"change\", function ()\r\n        " +
"    {\r\n                // \"other\" reasons\r\n                if (event.srcElement." +
"value == \"Reason5\" || event.srcElement.value == \"Reason10\")\r\n                {\r\n" +
"                    Ext.get(\"CloseReasonOther\").removeClass(\"readonly\");\r\n      " +
"              Ext.getDom(\"CloseReasonOther\").disabled = false;\r\n                " +
"}\r\n                else\r\n                {\r\n                    Ext.get(\"CloseRe" +
"asonOther\").addClass(\"readonly\");\r\n                    Ext.getDom(\"CloseReasonOt" +
"her\").disabled = true;\r\n                    Ext.getDom(\"CloseReasonOther\").value" +
" = \"\";\r\n                }\r\n            });\r\n        });\r\n\r\n        var submitFor" +
"m = function ()\r\n        {\r\n            var closeReason = Ext.getDom(\"CloseReaso" +
"n\");\r\n            if (closeReason.value == \"\")\r\n            {\r\n                a" +
"lert(\"");

            
            #line 62 "..\..\Views\Deal\Close.cshtml"
...
WriteLiteral(@""");
            ...
            #line 70 "..\..\Views\Deal\Close.cshtml"
...
WriteLiteral(@"');
            ...
            #line 95 "..\..\Views\Deal\Close.cshtml"
...
".getDom(\"Comment\").disabled = false;\r\n        };\r\n    </script>\r\n");
     ...
     using (Html.BeginForm(null, null, null, FormMethod.Post, new Dictionary<string, object> { { "id", "EntityForm" } }))
    {
            ...
            #line 150 "..\..\Views\Deal\Close.cshtml"
...
WriteLiteral("                        ");
            ...
            #line 159 "..\..\Views\Deal\Close.cshtml"
                   Write(Model.Message);
...
WriteLiteral("                    ");
            ...
            #line 178 "..\..\Views\Deal\Close.cshtml"
...
WriteLiteral("                    ");
            ...
            #line 192 "..\..\Views\Deal\Close.cshtml"
