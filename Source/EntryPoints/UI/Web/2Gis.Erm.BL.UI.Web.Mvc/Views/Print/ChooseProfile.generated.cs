...
WriteAttribute("src", Tuple.Create(" src=\"", 338), Tuple.Create("\"", 398)
, Tuple.Create(Tuple.Create("", 344), Tuple.Create("/Scripts/Tooltip.js?", 344), true)
...
WriteAttribute("src", Tuple.Create(" src=\"", 445), Tuple.Create("\"", 526)
, Tuple.Create(Tuple.Create("", 451), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 451), true)
...
WriteAttribute("onmouseover", Tuple.Create(" \r\n                             onmouseover=\"", 2153), Tuple.Create("\"", 2225)
, Tuple.Create(Tuple.Create("", 2198), Tuple.Create("AddTooltip(", 2198), true)
            
            #line 55 "..\..\Views\Print\ChooseProfile.cshtml"
, Tuple.Create(Tuple.Create("", 2209), Tuple.Create<System.Object, System.Int32>(Model.Message
...
WriteLiteral("                            ");
            ...
            #line 78 "..\..\Views\Print\ChooseProfile.cshtml"
