...
namespace DoubleGis.Erm.BL.UI.Web.Mvc.Views.Client
{
    ...
    public partial class Merge : System.Web.Mvc.WebViewPage<MergeClientsViewModel>
    {
        public Merge()
        {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 287), Tuple.Create("\"", 352)
, Tuple.Create(Tuple.Create("", 293), Tuple.Create("/Scripts/MergeClients.js?", 293), true)
            
            #line 14 "..\..\Views\Client\Merge.cshtml"
, Tuple.Create(Tuple.Create("", 318), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
