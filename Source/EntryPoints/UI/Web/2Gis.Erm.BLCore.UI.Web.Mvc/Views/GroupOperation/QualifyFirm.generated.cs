...
WriteAttribute("href", Tuple.Create(" href=\"", 525), Tuple.Create("\"", 588)
, Tuple.Create(Tuple.Create("", 532), Tuple.Create("/Content/Progress.css?", 532), true)
            
            #line 14 "..\..\Views\GroupOperation\QualifyFirm.cshtml"
, Tuple.Create(Tuple.Create("", 554), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 727), Tuple.Create("\"", 808)
, Tuple.Create(Tuple.Create("", 733), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 733), true)
