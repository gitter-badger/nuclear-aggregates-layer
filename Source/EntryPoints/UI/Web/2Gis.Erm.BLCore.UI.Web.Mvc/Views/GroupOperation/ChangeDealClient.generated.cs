...
WriteAttribute("src", Tuple.Create(" src=\"", 618), Tuple.Create("\"", 691)
, Tuple.Create(Tuple.Create("", 624), Tuple.Create("/Scripts/Ext.Ajax.syncRequest.js?", 624), true)
            
            #line 16 "..\..\Views\GroupOperation\ChangeDealClient.cshtml"
, Tuple.Create(Tuple.Create("", 657), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 738), Tuple.Create("\"", 819)
, Tuple.Create(Tuple.Create("", 744), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 744), true)
