...
WriteAttribute("href", Tuple.Create(" href=\"", 536), Tuple.Create("\"", 599)
...
, Tuple.Create(Tuple.Create("", 565), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 622), Tuple.Create("\"", 695)
, Tuple.Create(Tuple.Create("", 628), Tuple.Create("/Scripts/Ext.Ajax.syncRequest.js?", 628), true)
            
            #line 16 "..\..\Views\GroupOperation\DisqualifyClient.cshtml"
, Tuple.Create(Tuple.Create("", 661), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 742), Tuple.Create("\"", 823)
, Tuple.Create(Tuple.Create("", 748), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 748), true)
