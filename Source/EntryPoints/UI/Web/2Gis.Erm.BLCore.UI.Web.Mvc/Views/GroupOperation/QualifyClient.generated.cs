...
WriteAttribute("href", Tuple.Create(" href=\"", 535), Tuple.Create("\"", 598)
...
WriteAttribute("src", Tuple.Create(" src=\"", 617), Tuple.Create("\"", 690)
, Tuple.Create(Tuple.Create("", 623), Tuple.Create("/Scripts/Ext.Ajax.syncRequest.js?", 623), true)
...
WriteAttribute("src", Tuple.Create(" src=\"", 737), Tuple.Create("\"", 818)
, Tuple.Create(Tuple.Create("", 743), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 743), true)
