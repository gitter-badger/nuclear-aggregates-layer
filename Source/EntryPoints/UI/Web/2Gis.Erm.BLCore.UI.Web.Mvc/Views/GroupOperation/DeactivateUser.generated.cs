...
WriteAttribute("src", Tuple.Create(" src=\"", 842), Tuple.Create("\"", 915)
, Tuple.Create(Tuple.Create("", 848), Tuple.Create("/Scripts/Ext.Ajax.syncRequest.js?", 848), true)
...
WriteAttribute("src", Tuple.Create(" src=\"", 962), Tuple.Create("\"", 1043)
, Tuple.Create(Tuple.Create("", 968), Tuple.Create("/Scripts/DoubleGis.UI.GroupOperations.js?", 968), true)
            
            #line 20 "..\..\Views\GroupOperation\DeactivateUser.cshtml"
, Tuple.Create(Tuple.Create("", 1009), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 1090), Tuple.Create("\"", 1150)
, Tuple.Create(Tuple.Create("", 1096), Tuple.Create("/Scripts/Tooltip.js?", 1096), true)
            
            #line 21 "..\..\Views\GroupOperation\DeactivateUser.cshtml"
, Tuple.Create(Tuple.Create("", 1116), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("onmouseover", Tuple.Create(" \r\n                             onmouseover=\"", 5999), Tuple.Create("\"", 6071)
, Tuple.Create(Tuple.Create("", 6044), Tuple.Create("AddTooltip(", 6044), true)
            
            #line 121 "..\..\Views\GroupOperation\DeactivateUser.cshtml"
, Tuple.Create(Tuple.Create("", 6055), Tuple.Create<System.Object, System.Int32>(Model.Message
            
            #line default
            #line hidden
, 6055), false)
, Tuple.Create(Tuple.Create("", 6069), Tuple.Create(");", 6069), true)
);
