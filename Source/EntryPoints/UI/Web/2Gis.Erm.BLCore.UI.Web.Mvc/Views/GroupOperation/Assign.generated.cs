...
"        var dialogArguments = !window.dialogArguments ? [] : (window.dialogArgum" +
"ents.Values ? window.dialogArguments.Values : window.dialogArguments);\r\n        " +
"    var ids = dialogArguments;\r\n\r\n            var isExtendedMode = (Ext.isArray(" +
"dialogArguments) && dialogArguments.length > 0 && Ext.isObject(dialogArguments[0" +
"]) && dialogArguments[0].hasOwnProperty(\'entityId\'));\r\n            if (isExtende" +
"dMode) {\r\n            \tids = [];\r\n            \tExt.each(dialogArguments, functio" +
"n (x) { ids.push(x.entityId); });\r\n            }\r\n\r\n            //window.Tooltip" +
" = new Ext.DoubleGis.UI.Tooltip(document);\r\n            Ext.getDom(\'DivErrors\')." +
"style.visibility = \'hidden\';\r\n            Ext.getDom(\'PageContentCell\').style[\"v" +
"ertical-align\"] = \"top\";\r\n            var config = {\r\n            \tEntitiesToPro" +
"cess: isExtendedMode ? dialogArguments : null,\r\n            \tEntities: ids, // м" +
"ассив id сущностей\r\n                OperationName: \'");
...
WriteAttribute("value", Tuple.Create(" value=\"", 10595), Tuple.Create("\"", 10618)
            
            #line 198 "..\..\Views\GroupOperation\Assign.cshtml"
, Tuple.Create(Tuple.Create("", 10603), Tuple.Create<System.Object, System.Int32>(Guid.NewGuid()
...
WriteLiteral("                            ");
            ...
            #line 216 "..\..\Views\GroupOperation\Assign.cshtml"
                       Write(Model.Message);
...
WriteLiteral("                                        ");
            ...
            #line 252 "..\..\Views\GroupOperation\Assign.cshtml"
...
"               </td>\r\n                </tr>\r\n");
            ...
            #line 259 "..\..\Views\GroupOperation\Assign.cshtml"
...
WriteAttribute("disabled", Tuple.Create(" disabled=\"", 13976), Tuple.Create("\"", 14018)
            
            #line 263 "..\..\Views\GroupOperation\Assign.cshtml"
                                          , Tuple.Create(Tuple.Create("", 13987), Tuple.Create<System.Object, System.Int32>(Model.IsCascadeAssignForbidden
...
WriteLiteral("                                ");
            ...
            #line 267 "..\..\Views\GroupOperation\Assign.cshtml"
...
"          </tr>\r\n");
            ...
            #line 271 "..\..\Views\GroupOperation\Assign.cshtml"
