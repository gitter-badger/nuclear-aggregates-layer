...
WriteAttribute("href", Tuple.Create(" href=\"", 753), Tuple.Create("\"", 816)
, Tuple.Create(Tuple.Create("", 760), Tuple.Create("/Content/Progress.css?", 760), true)
            
            #line 17 "..\..\Views\GroupOperation\Deactivate.cshtml"
, Tuple.Create(Tuple.Create("", 782), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("onmouseover", Tuple.Create(" \r\n                        onmouseover=\"", 4181), Tuple.Create("\"", 4248)
, Tuple.Create(Tuple.Create("", 4221), Tuple.Create("AddTooltip(", 4221), true)
            
            #line 77 "..\..\Views\GroupOperation\Deactivate.cshtml"
, Tuple.Create(Tuple.Create("", 4232), Tuple.Create<System.Object, System.Int32>(Model.Message
