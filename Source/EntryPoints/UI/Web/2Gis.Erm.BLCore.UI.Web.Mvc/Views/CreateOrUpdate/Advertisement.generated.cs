...
WriteAttribute("src", Tuple.Create(" src=\"", 122), Tuple.Create("\"", 203)
, Tuple.Create(Tuple.Create("", 128), Tuple.Create("/Scripts/Ext.ux.AdvertisementBagPanel.js?", 128), true)
...
WriteAttribute("title", Tuple.Create(" title=\"", 3280), Tuple.Create("\"", 3316)
            
            #line 92 "..\..\Views\CreateOrUpdate\Advertisement.cshtml"
, Tuple.Create(Tuple.Create("", 3288), Tuple.Create<System.Object, System.Int32>(BLResources.GeneralTabTitle
