...
namespace DoubleGis.Erm.BLCore.UI.Web.Mvc.Views.CreateOrUpdate
{
    ...
    public partial class Task : System.Web.Mvc.WebViewPage<TaskViewModel>
    {
        public Task()
        {
        }
...
WriteAttribute("src", Tuple.Create(" src=\"", 117), Tuple.Create("\"", 189)
, Tuple.Create(Tuple.Create("", 123), Tuple.Create("/Scripts/Ext.ux.TimeComboBox.js?", 123), true)
            
            #line 10 "..\..\Views\CreateOrUpdate\Task.cshtml"
, Tuple.Create(Tuple.Create("", 155), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 236), Tuple.Create("\"", 318)
, Tuple.Create(Tuple.Create("", 242), Tuple.Create("/Scripts/Ext.DoubleGis.UI.ActivityBase.js?", 242), true)
            
            #line 11 "..\..\Views\CreateOrUpdate\Task.cshtml"
, Tuple.Create(Tuple.Create("", 284), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
