...
WriteAttribute("href", Tuple.Create(" href=\"", 461), Tuple.Create("\"", 545)
, Tuple.Create(Tuple.Create("", 468), Tuple.Create("/Content/Ext.ux.DetailedProgressWindow.css?", 468), true)
            ...
            #line 15 "..\..\Views\Order\GetOrdersWithDummyAdvertisementDialog.cshtml"
             , Tuple.Create(Tuple.Create("", 511), Tuple.Create<System.Object, System.Int32>(SolutionInfo.ProductVersion.Build
...
WriteAttribute("src", Tuple.Create(" src=\"", 568), Tuple.Create("\"", 650)
, Tuple.Create(Tuple.Create("", 574), Tuple.Create("/Scripts/Ext.ux.DetailedProgressWindow.js?", 574), true)
...
WriteAttribute("src", Tuple.Create(" src=\"", 697), Tuple.Create("\"", 784)
, Tuple.Create(Tuple.Create("", 703), Tuple.Create("/Scripts/Ext.ux.AsyncOperationClientManager.js?", 703), true)
...
WriteAttribute("value", Tuple.Create(" value=\"", 2396), Tuple.Create("\"", 2427)
            
            #line 60 "..\..\Views\Order\GetOrdersWithDummyAdvertisementDialog.cshtml"
, Tuple.Create(Tuple.Create("", 2404), Tuple.Create<System.Object, System.Int32>(Model.OrdersListFileId
...
WriteLiteral("                ");
           ...
           Write(Html.TemplateField(m => m.OrganizationUnit, FieldFlex.lone, new LookupSettings { EntityName = EntityName.OrganizationUnit, SearchFormFilterInfo = "IsDeleted=false&&IsActive=true", ExtendedInfo = "userId=" + Model.UserId }));
