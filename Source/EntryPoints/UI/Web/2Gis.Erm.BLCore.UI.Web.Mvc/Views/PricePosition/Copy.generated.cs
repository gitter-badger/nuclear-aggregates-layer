...
namespace DoubleGis.Erm.BLCore.UI.Web.Mvc.Views.PricePosition
{
    using System;
...
WriteLiteral("            ");
       ...
       Write(Html.TemplateField(m => m.Position, FieldFlex.lone, new LookupSettings { EntityName = EntityName.Position, SearchFormFilterInfo = "IsDeleted=false&&IsActive=true" }));
