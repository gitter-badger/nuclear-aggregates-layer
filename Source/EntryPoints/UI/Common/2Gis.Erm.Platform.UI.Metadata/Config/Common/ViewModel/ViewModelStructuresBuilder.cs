...
{
    public abstract class ViewModelStructuresBuilder<TBuilder, TElement, TIdentity> : ConfigElementBuilder<TBuilder, TElement>
        where TBuilder : ViewModelStructuresBuilder<TBuilder, TElement, TIdentity>, new()
        where TElement : ViewModelStructure<TElement, TIdentity, TBuilder> 
        where TIdentity : class, IConfigElementIdentity
    {
        private readonly TitleFeatureAspect<TBuilder, TElement> _title;
        private readonly OperationBoundFeatureAspect<TBuilder, TElement> _operation;
        ...
        protected ViewModelStructuresBuilder()
        {
            _title = new TitleFeatureAspect<TBuilder, TElement>(this);
            _operation = new OperationBoundFeatureAspect<TBuilder, TElement>(this);
        ...
        public OperationBoundFeatureAspect<TBuilder, TElement> Operation
        {
        ...
        {
            Features.Add(new DynamicPropertiesFeature());
