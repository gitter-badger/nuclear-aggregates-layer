...
namespace DoubleGis.Erm.BLCore.Releasing.Release
{
    ...
    public sealed class OrdersWithAdvertisementMaterialsXmlSerializer : IOrdersWithAdvertisementMaterialsSerializer
    {
        ...
        // FIXME {all, 21.08.2013}: это УГ оставлено для выявления у позиции заказа рекламных материалов старого формата (мигрировавших из ДГПП и т.д.). Через некоторое время после выхода 1.0 (например 2-3 сборки) нужно удалить.
