...
namespace DoubleGis.Erm.BLFlex.Aggregates.Global.Chile.Orders
{
    public static class OrderSpecifications
    {
        ...
        {
            public static ISelectSpecification<Order, ChileOrderGridViewDto> OrdersForCzechGridView()
            {
                return new SelectSpecification<Order, ChileOrderGridViewDto>(
                    order => new ChileOrderGridViewDto
                    {
                        Id = order.Id,
