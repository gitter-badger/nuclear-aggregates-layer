...
namespace DoubleGis.Erm.BLFlex.Aggregates.Global.Multiculture.Orders.DTO
{
    public sealed class MultiCultureOrderGridViewDto : IChileAdapted, ICyprusAdapted, ICzechAdapted, IUkraineAdapted
    {
