...
{
    // 2+ :BL\Source\ApplicationServices\2Gis.Erm.BLCore.Operations\Generic\Get\GetClientDtoService.cs
    public class GetClientDtoService : GetDomainEntityDtoServiceBase<Client>
    {
