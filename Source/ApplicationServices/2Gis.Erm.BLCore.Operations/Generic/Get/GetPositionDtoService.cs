                             ...
                             .Select(entity => new PositionDomainEntityDto
                                 {
                                     ...
                                     BindingObjectTypeEnum = (PositionBindingObjectType)entity.BindingObjectTypeEnum,
                                     AccountingMethodEnum = (PositionAccountingMethod)entity.AccountingMethodEnum,
                                     CalculationMethodEnum = (PositionCalculationMethod)entity.CalculationMethodEnum,
