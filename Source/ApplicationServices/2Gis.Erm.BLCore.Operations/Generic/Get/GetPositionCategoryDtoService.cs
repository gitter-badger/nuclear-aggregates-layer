...
namespace DoubleGis.Erm.BLCore.Operations.Generic.Get
{
    public class GetPositionCategoryDtoService : GetDomainEntityDtoServiceBase<PositionCategory>
    {
        ...
        public GetPositionCategoryDtoService(IUserContext userContext, ISecureFinder finder, IAPIIdentityServiceSettings identityServiceSettings) : base(userContext)
        {
            _finder = finder;
