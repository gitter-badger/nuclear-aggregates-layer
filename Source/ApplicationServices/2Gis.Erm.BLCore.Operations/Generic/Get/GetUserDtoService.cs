...
namespace DoubleGis.Erm.BLCore.Operations.Generic.Get
{
    public class GetUserDtoService : GetDomainEntityDtoServiceBase<User>
    {
        ...
        public GetUserDtoService(IUserContext userContext, IFinder finder, IAPIIdentityServiceSettings identityServiceSettings) : base(userContext)
        {
            _finder = finder;
        ...
        protected override IDomainEntityDto<User> CreateDto(long? parentEntityId, EntityName parentEntityName, string extendedInfo)
        {
