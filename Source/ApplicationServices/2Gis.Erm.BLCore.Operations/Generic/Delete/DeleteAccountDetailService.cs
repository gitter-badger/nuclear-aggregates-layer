...
{
    public sealed class DeleteAccountDetailService : IDeleteGenericEntityService<AccountDetail>
    {
        private readonly IAccountRepository _accountRepository;

        public DeleteAccountDetailService(IAccountRepository accountRepository)
        {
