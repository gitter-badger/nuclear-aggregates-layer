...
{
    public class DeleteLockDetailService : IDeleteGenericEntityService<LockDetail>
    {
        private readonly IAccountRepository _accountAggregateRepository;

        public DeleteLockDetailService(IAccountRepository accountAggregateRepository)
        {
