...
{
    public class ActivateAssociatedPositionsGroupService : IActivateGenericEntityService<AssociatedPositionsGroup>
    {
        private readonly IPriceRepository _priceRepository;

        public ActivateAssociatedPositionsGroupService(IPriceRepository priceRepository)
        {
