...
namespace DoubleGis.Erm.BLCore.Operations.Generic.Activate
{
    public class ActivatePricePositionService : IActivateGenericEntityService<PricePosition>
    {
        ...
        public ActivatePricePositionService(IPriceRepository priceRepository)
        {
        ...
        public int Activate(long entityId)
        {
            ...
            {
                var activateAggregateRepository = _priceRepository as IActivateAggregateRepository<PricePosition>;
