...
namespace DoubleGis.Erm.BLCore.Operations.Generic.List
{
    public class ListPrintFormTemplateService : ListEntityDtoServiceBase<PrintFormTemplate, ListPrintFormTemplateDto>
    {
        ...
        protected override IEnumerable<ListPrintFormTemplateDto> GetListData(IQueryable<PrintFormTemplate> query, QuerySettings querySettings, ListFilterManager filterManager, out int count)
        {
            var data = query
            .Select(x => new
            {
