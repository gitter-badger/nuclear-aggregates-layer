...
{
    public class DeactivateAssociatedPositionsGroupService : IDeactivateGenericEntityService<AssociatedPositionsGroup>
    {
        private readonly IPriceRepository _priceRepository;

        public DeactivateAssociatedPositionsGroupService(IPriceRepository priceRepository)
        {
