...
{
    public class DeactivateOrganizationUnitService : IDeactivateGenericEntityService<OrganizationUnit>
    {
        private readonly IUserRepository _userRepository;

        public DeactivateOrganizationUnitService(IUserRepository userRepository)
        {
