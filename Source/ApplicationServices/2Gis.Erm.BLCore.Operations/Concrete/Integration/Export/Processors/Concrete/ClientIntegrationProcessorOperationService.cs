...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class ClientIntegrationProcessorOperationService : IntegrationProcessorOperationService<Client, ExportFlowFinancialDataClient>
    {
        public ClientIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<Client, ExportFlowFinancialDataClient> processingsStoreService,
