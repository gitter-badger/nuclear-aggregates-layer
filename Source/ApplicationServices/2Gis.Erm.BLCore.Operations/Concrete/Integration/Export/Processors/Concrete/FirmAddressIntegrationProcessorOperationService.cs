...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class FirmAddressIntegrationProcessorOperationService : IntegrationProcessorOperationService<FirmAddress, ExportFlowCardExtensionsCardCommercial>
    {
        public FirmAddressIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<FirmAddress, ExportFlowCardExtensionsCardCommercial> processingsStoreService,
