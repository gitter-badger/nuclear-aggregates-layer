...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class AdvertismentIntegrationProcessorOperationService : IntegrationProcessorOperationService<Advertisement, ExportFlowOrdersAdvMaterial>
    {
        public AdvertismentIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<Advertisement, ExportFlowOrdersAdvMaterial> processingsStoreService,
