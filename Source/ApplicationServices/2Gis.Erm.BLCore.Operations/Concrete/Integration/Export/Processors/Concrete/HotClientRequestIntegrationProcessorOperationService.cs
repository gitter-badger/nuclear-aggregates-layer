...
namespace DoubleGis.Erm.BLCore.Operations.Concrete.Integration.Export.Processors.Concrete
{
    ...
    public sealed class HotClientRequestIntegrationProcessorOperationService : IntegrationProcessorOperationService<HotClientRequest, ExportToMsCrm_HotClients>
    {
        public HotClientRequestIntegrationProcessorOperationService(
            IOperationsProcessingsStoreService<HotClientRequest, ExportToMsCrm_HotClients> processingsStoreService,
