    ...
    public static partial class OrderSpecs
    {
        public static class Orders
        {
            public static class Find
            {
                ...
                {
                    return new FindSpecification<Order>(o => o.BranchOfficeOrganizationUnit.Accounts.Any(a => a.Id == accountId && a.LegalPersonId == o.LegalPersonId));
                }
                ...
                public static FindSpecification<Order> ReleasableStatuses
                {
                    get
                    {
                        return new FindSpecification<Order>(o => o.WorkflowStepId == (int)OrderState.Approved || o.WorkflowStepId == (int)OrderState.OnTermination);
                    }
                }
