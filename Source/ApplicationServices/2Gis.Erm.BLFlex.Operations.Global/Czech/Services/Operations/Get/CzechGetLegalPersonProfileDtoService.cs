...
{
    public class CzechGetLegalPersonProfileDtoService : GetDomainEntityDtoServiceBase<LegalPersonProfile>, ICzechAdapted
    {
        private readonly ISecureFinder _finder;

        public CzechGetLegalPersonProfileDtoService(IUserContext userContext, ISecureFinder finder)
            : base(userContext)
        {
            _finder = finder;
        }
