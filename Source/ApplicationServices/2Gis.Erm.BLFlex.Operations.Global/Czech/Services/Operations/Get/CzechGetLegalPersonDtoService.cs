...
{
    public class CzechGetLegalPersonDtoService : GetDomainEntityDtoServiceBase<LegalPerson>, ICzechAdapted
    {
        private readonly ISecureFinder _finder;

        public CzechGetLegalPersonDtoService(IUserContext userContext, ISecureFinder finder)
            : base(userContext)
        {
            _finder = finder;
        }
