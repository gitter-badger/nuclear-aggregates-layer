...
{
    public class CzechGetPhonecallDtoService : GetDomainEntityDtoServiceBase<Phonecall>, ICzechAdapted
    {
        private readonly IFinder _finder;
        private readonly IActivityService _activityService;
        private readonly IUserContext _userContext;

        public CzechGetPhonecallDtoService(IUserContext userContext, IFinder finder, IActivityService activityService)
            : base(userContext)
        {
            _finder = finder;
