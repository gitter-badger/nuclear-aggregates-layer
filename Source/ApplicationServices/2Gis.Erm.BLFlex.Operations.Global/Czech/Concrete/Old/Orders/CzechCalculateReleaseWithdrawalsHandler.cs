...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Czech.Concrete.Old.Orders
{
    public sealed class CzechCalculateReleaseWithdrawalsHandler : RequestHandler<CalculateReleaseWithdrawalsRequest, EmptyResponse>, ICzechAdapted
    {
        ...
        public CzechCalculateReleaseWithdrawalsHandler(
            IFinder finder,
