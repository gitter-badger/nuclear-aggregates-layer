...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Czech.Concrete.Old.Bills
{
    public sealed class CzechPrintBillHandler : RequestHandler<PrintBillRequest, Response>, ICzechAdapted
    {
        ...
        public CzechPrintBillHandler(ISubRequestProcessor requestProcessor, IFormatterFactory formatterFactory, IFinder finder, IPrintValidationOperationService validationService)
        {
            _finder = finder;
