...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Cyprus.Services.Operations.Obtain
{
    public sealed class CyprusAppointmentObtainer : IBusinessModelEntityObtainer<Appointment>, IAggregateReadModel<ActivityBase>, ICyprusAdapted
    {
        private readonly IActivityService _activityService;
        private readonly IUserContext _userContext;

        public CyprusAppointmentObtainer(IActivityService activityService, IUserContext userContext)
        {
