...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Cyprus.Concrete.Old.Bills
{
    public sealed class CyprusPrintBillHandler : RequestHandler<PrintBillRequest, Response>, ICyprusAdapted
    {
        ...
        public CyprusPrintBillHandler(ISubRequestProcessor requestProcessor, IFormatterFactory formatterFactory, IFinder finder, IPrintValidationOperationService validationService)
        {
            _finder = finder;
