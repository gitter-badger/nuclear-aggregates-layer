...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Cyprus.Concrete.Old.Orders
{
    public sealed class CyprusCalculateReleaseWithdrawalsHandler : RequestHandler<CalculateReleaseWithdrawalsRequest, EmptyResponse>, ICyprusAdapted
    {
        ...
        public CyprusCalculateReleaseWithdrawalsHandler(
            IFinder finder,
        ...
        private IEnumerable<ReleasesWithdrawalsPosition> CreateReleaseWithdrawalPositionsForCompositePositionWithMoDi(OrderPositionDto orderPosition)
        {
            ...
            var platformMap = _finder.Find<DoubleGis.Erm.Platform.Model.Entities.Erm.Platform>(x => platformDgppIds.Contains(x.DgppId)).ToDictionary(x => (PlatformEnum)x.DgppId, x => x.Id);
