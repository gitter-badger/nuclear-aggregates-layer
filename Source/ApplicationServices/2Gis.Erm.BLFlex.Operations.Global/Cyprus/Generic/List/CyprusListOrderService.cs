...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Cyprus.Generic.List
{
    public class CyprusListOrderService : ListEntityDtoServiceBase<Order, CyprusListOrderDto>, ICyprusAdapted
    {
        ...
        protected override IEnumerable<CyprusListOrderDto> GetListData(IQueryable<Order> query, QuerySettings querySettings, ListFilterManager filterManager, out int count)
        {
