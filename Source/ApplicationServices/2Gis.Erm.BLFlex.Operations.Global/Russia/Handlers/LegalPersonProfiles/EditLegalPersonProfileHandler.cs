...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Russia.Handlers.LegalPersonProfiles
{
    public sealed class EditLegalPersonProfileHandler : RequestHandler<EditRequest<LegalPersonProfile>, EmptyResponse>, IRussiaAdapted
    {
        private readonly ILegalPersonRepository _legalPersonRepository;
        private readonly IOperationScopeFactory _scopeFactory;

        public EditLegalPersonProfileHandler(ILegalPersonRepository legalPersonRepository, IOperationScopeFactory scopeFactory)
        {
            ...
            using (var operationScope = _scopeFactory.CreateOrUpdateOperationFor(request.Entity))
            {
                ...
                switch (modelLegalPersonType)
                {
                    case LegalPersonType.LegalPerson:
                        if (string.IsNullOrEmpty(request.Entity.PositionInGenitive))
                        {
                            throw new NotificationException(string.Format(BLResources.RequiredFieldMessage, MetadataResources.PositionInGenitive));
                        }
