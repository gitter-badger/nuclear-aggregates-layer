...
namespace DoubleGis.Erm.BLFlex.Operations.Global.DuplicatesFromOperations
{
    ...
    internal sealed class CzechGetAppointmentDtoService : GetDomainEntityDtoServiceBase<Appointment>, ICzechAdapted
    {
        private readonly IFinder _finder;
        private readonly IActivityReadModel _activityReadModel;
        private readonly IUserContext _userContext;

        public CzechGetAppointmentDtoService(IUserContext userContext, IFinder finder, IActivityReadModel activityReadModel)
            : base(userContext)
        {
            _finder = finder;
