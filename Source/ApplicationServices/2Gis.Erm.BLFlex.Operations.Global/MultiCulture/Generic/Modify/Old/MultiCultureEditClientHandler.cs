...
{
    public sealed class MultiCultureEditClientHandler : RequestHandler<EditRequest<Client>, EmptyResponse>, IChileAdapted, ICyprusAdapted, ICzechAdapted, IUkraineAdapted
    {
        private readonly IClientRepository _clientRepository;
        private readonly IOperationScopeFactory _operationScopeFactory;

        public MultiCultureEditClientHandler(
