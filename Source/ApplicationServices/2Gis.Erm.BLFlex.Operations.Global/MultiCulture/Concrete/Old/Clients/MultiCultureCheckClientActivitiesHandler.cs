...
namespace DoubleGis.Erm.BLFlex.Operations.Global.MultiCulture.Concrete.Old.Clients
{
                                                            ...
                                                            ICzechAdapted, IUkraineAdapted, IEmiratesAdapted
    {
        ...
        public MultiCultureCheckClientActivitiesHandler(IActivityReadService activityReadService)
        {
        ...
        protected override EmptyResponse Handle(CheckClientActivitiesRequest request)
        {
            ...
            var hasRelatedOpenedActivities = _activityReadService.CheckIfRelatedActivitiesExists(EntityName.Client, request.ClientId);
