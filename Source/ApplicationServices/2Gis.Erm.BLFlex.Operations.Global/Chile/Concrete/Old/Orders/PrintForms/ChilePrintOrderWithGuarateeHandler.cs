...
{
    public sealed class ChilePrintOrderWithGuarateeHandler : RequestHandler<PrintOrderWithGuarateeRequest, Response>, IChileAdapted
    {
        private readonly ISubRequestProcessor _requestProcessor;
        private readonly IOrderReadModel _orderReadModel;

        public ChilePrintOrderWithGuarateeHandler(ISubRequestProcessor requestProcessor, IOrderReadModel orderReadModel)
        {
