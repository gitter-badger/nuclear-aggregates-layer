...
{
    public sealed class ChileMergeLegalPersonsHandler : RequestHandler<MergeLegalPersonsRequest, EmptyResponse>, IChileAdapted
    {
        ...
        public ChileMergeLegalPersonsHandler(
        ...
        protected override EmptyResponse Handle(MergeLegalPersonsRequest request)
        {
            ...
            // Проверим, указан ли RUT
            if (string.IsNullOrWhiteSpace(mainLegalPerson.LegalPerson.Inn))
            {
            ...
            if (mainLegalPerson.LegalPerson.Inn != appendedLegalPerson.LegalPerson.Inn)
            {
