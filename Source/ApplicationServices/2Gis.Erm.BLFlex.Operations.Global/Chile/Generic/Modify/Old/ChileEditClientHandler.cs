...
namespace DoubleGis.Erm.BLFlex.Operations.Global.Chile.Generic.Modify.Old
{
    public sealed class ChileEditClientHandler : RequestHandler<EditRequest<Client>, EmptyResponse>, IChileAdapted
    {
        private readonly IClientRepository _clientRepository;
        private readonly IOperationScopeFactory _operationScopeFactory;

        public ChileEditClientHandler(
