...
namespace DoubleGis.Erm.Platform.DI.Config.MassProcessing.Validation
{
    ...
    /// </summary>
    public class CheckDomainModelEntitiesСlassificationMassProcessor : IMassProcessor
    {
        ...
        public void AfterProcessTypes(bool firstRun)
        {
            ...
            {
                // TODO {all, 26.07.2013}: Пока есть сущности прописанные как элменты разных агрегатов - нужно это исправить и включить проверку
