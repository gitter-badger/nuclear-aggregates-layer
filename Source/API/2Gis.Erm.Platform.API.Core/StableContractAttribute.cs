...
namespace DoubleGis.Erm.Platform.API.Core
{
    ...
    /// Чтобы в метаданных контрактов ERM типы имели правильные (AssemblyQualifiedNames) name/namespaces - используется механизм расширения генерируемых метаданных и он опирается 
