...
namespace DoubleGis.Erm.Qds.API.Operations.Indexing
{
    ...
    public interface IDocumentRelationMetadata<TDocument, in TDocumentPart> : IDocumentRelationMetadata
    {
    ...
    {
        IEnumerable<Tuple<Type, Type>> GetMetadatasForDocumentType(IEnumerable<Type> documentTypes);
        IEnumerable<Tuple<Type, Type>> GetMetadatasForDocumentPartType(IEnumerable<Type> documentPartTypes);
        IEnumerable<IDocumentRelationMetadata<TDocument, TDocumentPart>> GetMetadatas<TDocument, TDocumentPart>();

        void RegisterMetadata<TDocument, TDocumentPart>(IDocumentRelationMetadata metadata);
    }
}