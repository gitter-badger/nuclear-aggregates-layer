...
{
    [ServiceContract(SessionMode = SessionMode.Allowed, Namespace = ServiceNamespaces.Releasing.Release201308)]
    public interface IReleaseApplicationService
    {
        [OperationContract]
        [FaultContract(typeof(ReleasingErrorDescription), Namespace = ServiceNamespaces.Releasing.Release201308)]
