...
namespace DoubleGis.Erm.Platform.API.GeoMaster {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="AddressDesc", Namespace="http://2Gis/GeoMasterApi/2013/1")]
    [System.SerializableAttribute()]
    public partial class AddressDesc : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="NotFoundObject", Namespace="http://2Gis/GeoMasterApi/2013/1")]
    [System.SerializableAttribute()]
    public partial class NotFoundObject : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    public interface IMsReadApi {
        ...
        DoubleGis.Erm.Platform.API.GeoMaster.Capabilities GetCapabilities();
        
        // CODEGEN: Generating message contract since message GetAllPhoneZonesRequest has headers
        ...
        // CODEGEN: Generating message contract since message GetAddressesStringRequest has headers
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(DoubleGis.Erm.Platform.API.GeoMaster.NotFoundObject), Action="http://2Gis/GeoMasterApi/2013/1/IMsReadApi/GetAddressesStringNotFoundObjectFault", Name="NotFoundObject")]
    ...
    public partial class GetAddressesStringResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://2Gis/GeoMasterApi/2013/1", Order=0)]
        public DoubleGis.Erm.Platform.API.GeoMaster.AddressDesc[] GetAddressesStringResult;
        
        public GetAddressesStringResponse() {
        }
        
        public GetAddressesStringResponse(DoubleGis.Erm.Platform.API.GeoMaster.AddressDesc[] GetAddressesStringResult) {
    ...
    public partial class MsReadApiClient : System.ServiceModel.ClientBase<DoubleGis.Erm.Platform.API.GeoMaster.IMsReadApi>, DoubleGis.Erm.Platform.API.GeoMaster.IMsReadApi {
        ...
        public DoubleGis.Erm.Platform.API.GeoMaster.Capabilities GetCapabilities() {
            return base.Channel.GetCapabilities();
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        DoubleGis.Erm.Platform.API.GeoMaster.GetAllPhoneZonesResponse DoubleGis.Erm.Platform.API.GeoMaster.IMsReadApi.GetAllPhoneZones(DoubleGis.Erm.Platform.API.GeoMaster.GetAllPhoneZonesRequest request) {
            return base.Channel.GetAllPhoneZones(request);
        }
        
        public DoubleGis.Erm.Platform.API.GeoMaster.PhoneZone[] GetAllPhoneZones(DoubleGis.Erm.Platform.API.GeoMaster.Header MyHeader) {
            DoubleGis.Erm.Platform.API.GeoMaster.GetAllPhoneZonesRequest inValue = new DoubleGis.Erm.Platform.API.GeoMaster.GetAllPhoneZonesRequest();
            inValue.MyHeader = MyHeader;
            DoubleGis.Erm.Platform.API.GeoMaster.GetAllPhoneZonesResponse retVal = ((DoubleGis.Erm.Platform.API.GeoMaster.IMsReadApi)(this)).GetAllPhoneZones(inValue);
            return retVal.GetAllPhoneZonesResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        DoubleGis.Erm.Platform.API.GeoMaster.GetAddressesStringResponse DoubleGis.Erm.Platform.API.GeoMaster.IMsReadApi.GetAddressesString(DoubleGis.Erm.Platform.API.GeoMaster.GetAddressesStringRequest request) {
            return base.Channel.GetAddressesString(request);
        }
        
        public DoubleGis.Erm.Platform.API.GeoMaster.AddressDesc[] GetAddressesString(DoubleGis.Erm.Platform.API.GeoMaster.Header MyHeader, long[] codes) {
            DoubleGis.Erm.Platform.API.GeoMaster.GetAddressesStringRequest inValue = new DoubleGis.Erm.Platform.API.GeoMaster.GetAddressesStringRequest();
            inValue.MyHeader = MyHeader;
            inValue.codes = codes;
            DoubleGis.Erm.Platform.API.GeoMaster.GetAddressesStringResponse retVal = ((DoubleGis.Erm.Platform.API.GeoMaster.IMsReadApi)(this)).GetAddressesString(inValue);
            return retVal.GetAddressesStringResult;
        }
    }
}
