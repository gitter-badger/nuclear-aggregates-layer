...
namespace DoubleGis.Erm.Platform.DAL.EntityFramework
{
		...
		where TPersistentEntity : class, IEntity
    {
		...
		protected EFRepository(IUserContext userContext, IDomainContextSaveStrategy domainContextSaveStrategy, IModifiableDomainContextProvider domainContextProvider)
		{
			if (userContext == null)
			{
