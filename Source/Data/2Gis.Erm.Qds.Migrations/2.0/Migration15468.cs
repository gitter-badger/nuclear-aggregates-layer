...
{
    [Migration(15468, "Миграция данных", "f.zaharov")]
    public sealed class Migration15468 : ElasticSearchMigration
    {
        public override void Apply(IElasticSearchMigrationContext context)
        {
            ...
            context.ElasticManagementApi.CreateIndex<OrderGridDoc15468>(GetDataIndexDescriptor(), "Data");

            PutOrderDocMapping(context);
            IndexOrderDocIndex(context);
             ...
             * Cut for ERM-4267
                ...
                IndexAllFirmGridDoc(context);
             */
        }

        private static void IndexAllClientGridDoc(IElasticSearchMigrationContext context)
        {
            context.ReplicationQueue.Add(new ReplicationQueue { DocumentType = "ClientGridDoc" });
        }

        private static void IndexAllUserDoc(IElasticSearchMigrationContext context)
        {
            context.ReplicationQueue.Add(new ReplicationQueue { DocumentType = "UserDoc" });
        }
        ...
        private static void PutFirmGridDocMapping(IElasticSearchMigrationContext context)
        {
            ...
            context.ElasticManagementApi.CreateIndex<FirmGridDoc15468>(GetDataIndexDescriptor(), "Data");
        ...
        private static void IndexAllFirmGridDoc(IElasticSearchMigrationContext context)
        {
            context.ReplicationQueue.Add(new ReplicationQueue { DocumentType = "FirmGridDoc" });
        }
        ...
        void IndexOrderDocIndex(IElasticSearchMigrationContext context)
        {
            context.ReplicationQueue.Add(new ReplicationQueue { DocumentType = "OrderGridDoc" });
        }
        ...
        {
            context.ReplicationQueue.Add(new ReplicationQueue { DocumentType = "TerritoryDoc" });
        }
