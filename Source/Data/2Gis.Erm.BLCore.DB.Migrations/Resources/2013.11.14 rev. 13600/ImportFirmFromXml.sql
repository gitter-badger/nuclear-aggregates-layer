...
AS
    ...
    BEGIN TRY
        ...
        -- set firm territory
        UPDATE F
        SET F.TerritoryId = IsNull(FA.TerritoryId, B.TerritoryId)
        ...
        LEFT JOIN Integration.Buildings B ON B.Code = FA.BuildingCode
        ...
        INSERT INTO @TempTerritoriesTbl SELECT 
                ...
                AND IsActive = 1 AND Name like N'%' + @RegionalTerritoryLocalName + N'%'
