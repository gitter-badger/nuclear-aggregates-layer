...
{
    [Migration(10937, "У некоторых заказов не выставлена платформа - исправляем")]
    public sealed class Migration10937 : TransactedMigration
    {
  ...
  where o.PlatformId is null and o.IsActive = 1 and o.IsDeleted = 0 
