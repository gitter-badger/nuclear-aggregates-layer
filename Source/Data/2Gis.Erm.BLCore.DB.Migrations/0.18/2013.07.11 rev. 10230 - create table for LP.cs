...
{
    [Migration(10230, "Добавление таблицы обработки экспорта клиентов")]
    public class Migration10230 : TransactedMigration
    {
        protected override void ApplyOverride(IMigrationContext context)
        {
            CreateServiceBusExportTable(context, ErmTableNames.ExportFlowFinancialDataClient);
        }
