...
{
    [Migration(10677, "Alter на ImportCardsFromXml")]
    public sealed class Migration10677 : TransactedMigration
    {
...
BEGIN TRY
    ...
    BEGIN TRAN
       ...
       VALUES (NewValues.CategoryId, NewValues.AddressId, ~cards.IsArchived, cards.IsDeleted, @ModifiedBy, GETUTCDATE(), @OwnerCode, NewValues.SortingPosition, NewValues.IsPrimary, @ModifiedBy, GETUTCDATE());
