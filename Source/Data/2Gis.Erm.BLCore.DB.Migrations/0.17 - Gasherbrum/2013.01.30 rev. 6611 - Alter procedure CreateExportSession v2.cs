...
{
    [Migration(6611, "Исправление хранимки CreateExportSession. Добавил тип сущности ThemeOrganizationUnit, ThemeTemplate.")]
    public sealed class Migration6611 : TransactedMigration
    {
        #region Текст запроса

        private const string Query = @"
/****** Object:  StoredProcedure [Integration].[CreateExportSession]    Script Date: 30.01.2013 10:22:18 ******/
SET ANSI_NULLS ON
GO
