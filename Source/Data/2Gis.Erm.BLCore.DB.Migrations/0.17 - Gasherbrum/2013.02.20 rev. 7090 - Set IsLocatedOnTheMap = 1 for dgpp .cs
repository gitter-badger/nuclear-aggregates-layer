...
{
    [Migration(7090, "Для городов на дгпп признак пустого адреса неактуален, выставляем признак в - не пустой")]
    public sealed class Migration7090 : TransactedMigration
    {
