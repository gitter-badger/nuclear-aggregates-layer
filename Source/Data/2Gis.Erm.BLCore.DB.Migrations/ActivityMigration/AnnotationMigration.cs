...
SELECT {{0}}, {{1}}, Id, {{3}}, {{4}}, {{5}}, {{6}}, 0, {{7}}, {{8}}, {{9}} FROM {0} WHERE ReplicationCode = {{2}}";
	    ...
	    public AnnotationMigration() : base(1000)
	    {
	    }
		...
		internal override string BuildSql(Annotation annotation)
		{
              return 
                  ...
                  ? QueryBuilder.Format(GetFileTemplate(annotation.ParentEntity),
                    annotation.Id, annotation.ParentEntity, annotation.ParentId,
                    annotation.CreatedBy, annotation.CreatedOn, annotation.ModifiedBy, annotation.ModifiedOn, annotation.OwnerId,
                    annotation.Subject, 
                    annotation.FileId, annotation.FileName, annotation.FileSize, annotation.MimeType, annotation.DocumentBody)
                  : QueryBuilder.Format(GetNoteTemplate(annotation.ParentEntity),
                    annotation.Id, annotation.ParentEntity, annotation.ParentId,
                    annotation.CreatedBy, annotation.CreatedOn, annotation.ModifiedBy, annotation.ModifiedOn, annotation.OwnerId,
                    annotation.Subject, annotation.NoteText);
		}
