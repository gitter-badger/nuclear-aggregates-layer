...
{
    [Migration(6319, "Исправление хранимки CreateExportSession в части RecoverySession. EntityType передается через параметр")]
    public sealed class Migration6319 : TransactedMigration
    {
