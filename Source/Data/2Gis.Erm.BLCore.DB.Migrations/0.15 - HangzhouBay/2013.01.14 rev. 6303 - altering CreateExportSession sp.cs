...
{
    [Migration(6303, "Исправление хранимки CreateExportSession в части RecoverySession")]
    public sealed class Migration6303 : TransactedMigration
    {
...
BEGIN
	...
	(
		...
		FROM Integration.ExportSessionDetails IESD
		JOIN Integration.ExportSessions IES ON IES.Id = IESD.IntegrationExportSessionId AND IES.EntityType = 186
