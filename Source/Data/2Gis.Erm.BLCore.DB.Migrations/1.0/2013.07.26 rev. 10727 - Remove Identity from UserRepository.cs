...
{
    [Migration(10727, "Отключаем автоинкремент в таблицах UserOrganizationUnits, UserTerritories, UserRoles")]
    public class Migration10727 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables = 
        {
           ErmTableNames.UserOrganizationUnits,
           ErmTableNames.UserTerritories,
