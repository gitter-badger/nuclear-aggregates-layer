...
{
    [Migration(10741, "Отключаем автоинкремент в таблицах FunctionalPrivilegeDepths, UserEntities")]
    public class Migration10741 : TransactedMigration
    {
        private static readonly SchemaQualifiedObjectName[] Tables =
        {
            ErmTableNames.FunctionalPrivilegeDepths,
            ErmTableNames.UserEntities,
        };
