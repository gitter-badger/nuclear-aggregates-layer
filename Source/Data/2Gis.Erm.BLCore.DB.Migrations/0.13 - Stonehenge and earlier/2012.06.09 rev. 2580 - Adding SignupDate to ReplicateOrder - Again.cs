...
{
    [Migration(2580, "Добавление поля SignupDate в репликацию заказа")]
    public class Migration2580 : TransactedMigration
    {
	...
	RETURN 1;";
        ...
        protected override void ApplyOverride(IMigrationContext context)
        {
            ...
            var spTextBody = string.Format(CreateReplicateOrderSPTemplate, context.CrmDatabaseName);
