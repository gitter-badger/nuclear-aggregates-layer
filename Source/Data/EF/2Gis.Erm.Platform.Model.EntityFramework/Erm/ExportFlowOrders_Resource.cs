...
namespace DoubleGis.Erm.Model.Entities.Erm
{
    ...
    [KnownType(typeof(PerformedBusinessOperation))]
      ...
      public sealed partial class ExportFlowOrders_Resource: 
        ...
        private void FixupPerformedBusinessOperation(PerformedBusinessOperation previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.ExportFlowOrders_Resource, this))
            {
                previousValue.ExportFlowOrders_Resource = null;
            }
    
            if (PerformedBusinessOperation != null)
            {
                PerformedBusinessOperation.ExportFlowOrders_Resource = this;
