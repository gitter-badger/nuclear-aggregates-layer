...
namespace DoubleGis.Erm.Model.Entities.Erm
{
    ...
    [KnownType(typeof(PerformedBusinessOperation))]
      ...
      public sealed partial class ExportFlowOrders_Theme: 
        ...
        private void FixupPerformedBusinessOperation(PerformedBusinessOperation previousValue)
        {
            ...
            if (previousValue != null && ReferenceEquals(previousValue.ExportFlowOrders_Theme, this))
            {
                previousValue.ExportFlowOrders_Theme = null;
            }
    
            if (PerformedBusinessOperation != null)
            {
                PerformedBusinessOperation.ExportFlowOrders_Theme = this;
