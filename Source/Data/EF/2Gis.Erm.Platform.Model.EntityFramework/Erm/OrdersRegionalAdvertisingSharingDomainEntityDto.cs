...
{
    [DataContract]
    public partial class OrdersRegionalAdvertisingSharingDomainEntityDto : IDomainEntityDto<OrdersRegionalAdvertisingSharing>
    {
    	[DataMember]
    	...
    	[DataMember]
        public EntityReference RegionalAdvertisingSharingRef { get; set; }
    	[DataMember]
