...
using DoubleGis.Erm.BLFlex.Operations.Global.Czech.Generic.Get;
...
namespace DoubleGis.Erm.BLFlex.Tests.Unit.ApplicationServices.Operations.Global.Czech.Generic.Get
{
    public class CzechGetLegalPersonProfileDtoServiceSpecs
    {
        public abstract class CzechGetLegalPersonProfileDtoServiceContext
        {
            protected static CzechGetLegalPersonProfileDtoService CzechGetLegalPersonProfileDtoService;
            ...
            Establish context = () =>
                {
                    ...
                    CzechGetLegalPersonProfileDtoService = new CzechGetLegalPersonProfileDtoService(UserContext, SecureFinder, ReadModel);
                };
        }

        [Tags("GetDtoServie")]
        [Subject(typeof(CzechGetLegalPersonProfileDtoService))]
        class When_requested_existing_entity : CzechGetLegalPersonProfileDtoServiceContext
        {
            ...
            Because of = () =>
            {
                Result = CzechGetLegalPersonProfileDtoService.GetDomainEntityDto(EntityId, ReadOnly, ParentEntityId, ParentEntityName, ExtendedInfo);
            };
        ...
        [Tags("GetDtoServie")]
        [Subject(typeof(CzechGetLegalPersonProfileDtoService))]
        class When_requested_new_entity : CzechGetLegalPersonProfileDtoServiceContext
        {
        ...
        [Tags("GetDtoServie")]
        [Subject(typeof(CzechGetLegalPersonProfileDtoService))]
        class When_requested_new_entity_but_parentId_is_not_set : CzechGetLegalPersonProfileDtoServiceContext
        {
            static IUserIdentity _userIdentity;
            const long userCode = 2;
            const string TestLegalPersonName = "TestLegalPersonName";
            ...
            Because of = () => catchedException = Catch.Exception(() => CzechGetLegalPersonProfileDtoService.GetDomainEntityDto(EntityId, ReadOnly, ParentEntityId, ParentEntityName, ExtendedInfo));
        ...
        [Tags("GetDtoServie")]
        [Subject(typeof(CzechGetLegalPersonProfileDtoService))]
        class When_requested_new_entity_and_parent_entity_is_not_a_LegalPerson : CzechGetLegalPersonProfileDtoServiceContext
        {
            static IUserIdentity _userIdentity;
            const long userCode = 2;
            const string TestLegalPersonName = "TestLegalPersonName";
