...
{
    public class CzechGetLegalPersonDtoServiceSpecs
    {
        public abstract class CzechGetLegalPersonDtoServiceContext
        {
            protected static CzechGetLegalPersonDtoService CzechGetLegalPersonDtoService;
            ...
            Establish context = () =>
                {
                    ...
                    CzechGetLegalPersonDtoService = new CzechGetLegalPersonDtoService(UserContext, SecureFinder, ReadModel);
                };

            Because of = () =>
                {
                    Result = CzechGetLegalPersonDtoService.GetDomainEntityDto(EntityId, ReadOnly, ParentEntityId, ParentEntityName, ExtendedInfo);
                };
        }

        [Tags("GetDtoServie")]
        [Subject(typeof(CzechGetLegalPersonDtoService))]
        class When_requested_existing_entity : CzechGetLegalPersonDtoServiceContext
        {
        ...
        [Tags("GetDtoServie")]
        [Subject(typeof(CzechGetLegalPersonDtoService))]
        class When_requested_new_entity : CzechGetLegalPersonDtoServiceContext
        {
