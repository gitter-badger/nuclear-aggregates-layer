...
{
    public static class CzechFormatterSpecs
    {
        [Tags("BL", "Formatter", "Czech")]
        [Subject(typeof(CzechFormatterFactory))]
        public abstract class FormatterContext
        {
            ...
            Establish context = () =>
            {
                _factory = new CzechFormatterFactory();
            };
        }
        ...
        public class WhenFormattingMoney : FormatterContext
        {
            ...
            It should_format_as_koruna = () => _formatter.Format(1548.80).Should().Be("1 548,80 Kč");
            ...
            It should_not_depend_on_thread_culture = () =>
            {
                ...
                try
                {
                    _formatter.Format(1.0M).Should().Be("1,00 Kč");
                }
                finally
                {
