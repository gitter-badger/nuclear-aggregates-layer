...
{
    // 2+: BL\Source\Tests\2Gis.Erm.BLCore.Tests.Unit\BL\Client\CzechClientVewModelSpecs.cs
    public class CzechClientVewModelSpecs
    {
        [Tags("BL")]
        [Tags("CzechClientViewModel")]
        [Subject(typeof(CzechClientViewModel))]
        public abstract class LoadDomainEntityDtoContext
        {
            ...
            protected static CzechClientViewModel ViewModel { get; set; }
        ...
        public abstract class TransformToDomainEntityDtoContext
        {
            private Establish context = () =>
                {
                    ViewModel = new CzechClientViewModel
                        {
                            Id = 0,
            ...
            protected static CzechClientViewModel ViewModel { get; private set; }
        ...
        private class When_czech_adapted_client_dto_is_an_advertising_agency : LoadDomainEntityDtoContext
        {
            private Establish context = () =>
            {
                ViewModel = new CzechClientViewModel();
        ...
        private class When_czech_adapted_client_dto_is_not_an_advertising_agency : LoadDomainEntityDtoContext
        {
            private Establish context = () =>
            {
                ViewModel = new CzechClientViewModel();
