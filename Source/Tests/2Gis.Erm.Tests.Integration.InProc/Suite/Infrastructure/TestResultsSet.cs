...
namespace DoubleGis.Erm.Tests.Integration.InProc.Suite.Infrastructure
{
    public sealed class TestResultsSet
    {
        ...
        public IReadOnlyDictionary<IIntegrationTest, ITestResult> Ignored { get; set; }
        ...
        {
            get { return Succeeded.Count + Failed.Count + Ignored.Count + Unhandled.Count + Unresolved.Count; }
        }
