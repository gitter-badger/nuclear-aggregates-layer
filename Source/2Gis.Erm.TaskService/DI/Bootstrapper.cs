...
namespace DoubleGis.Erm.TaskService.DI
{
    ...
    {
        private static readonly Type[] EagerLoading = { typeof(TaskObtainer), typeof(ICleanupPersistenceService) }; // чтобы в домен загрузилась сборка 2Gis.Erm.BLFlex.Operations.Global
